...
Begin VB.Form frmnota_credito 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin KewlButtonz.KewlButtons buscar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_credito.frx":0442
         PICN            =   "frmnota_credito.frx":045E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_credito.frx":09F0
         PICN            =   "frmnota_credito.frx":0A0C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons grabar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_credito.frx":1556
         PICN            =   "frmnota_credito.frx":1572
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_credito.frx":2FF4
         PICN            =   "frmnota_credito.frx":3010
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSDataListLib.DataCombo DataCombo3 
         Bindings        =   "frmnota_credito.frx":3A22
         Height          =   360
         Left            =   9120
         TabIndex        =   4
         Top             =   600
      ...
      Begin KewlButtonz.KewlButtons bclientes 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_credito.frx":3A3C
         PICN            =   "frmnota_credito.frx":3A58
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons bvendedor 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_credito.frx":3FF2
         PICN            =   "frmnota_credito.frx":400E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmnota_credito.frx":45A8
         Height          =   375
         Left            =   4680
         TabIndex        =   35
         Top             =   360
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmnota_credito.frx":45C2
         Height          =   360
         Left            =   11160
         TabIndex        =   6
         Top             =   1080
      ...
      Begin KewlButtonz.KewlButtons agregaproducto 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_credito.frx":45E0
         PICN            =   "frmnota_credito.frx":45FC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons KewlButtons1 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_credito.frx":4B96
         PICN            =   "frmnota_credito.frx":4BB2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons blanco 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_credito.frx":514C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons negro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_credito.frx":5168
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmnota_credito.frx":5184
         Height          =   495
         Left            =   2880
         TabIndex        =   36
         Top             =   600
   ...
   End
End
Attribute VB_Name = "frmnota_credito"
...
Public xtotalfactura As Double ' Nuevo 28/12/2016
Public xfechafactura As Date ' Nuevo 28/12/2016
Public xsaldofactura As Double ' Nuevo 28/12/2016
...
Private Sub agregaproducto_Click()
    ...
    lista_productos_servicios_emporio.Show
...
'    Else
'        ximportesiva = Round(ximporte * xcant, 2)
'    End If
    
    ximportesiva = Round((ximporte / xiva) * xcant, 5)
    grilla.Col = 6
    ...
    xbonifporcent = grilla.TextMatrix(grilla.Row, 8)
'    xbonifimporte = grilla.TextMatrix(grilla.Row, 7)
...
'        xbonifporcent = Round((xbonifimporte / (xcant * ximporte)) * 100, 2)
    ...
    If xcol = 8 Or xcol = 3 Or xcol = 5 Or Val(Text10.Text) <> 0 Then
        grilla.Col = 8
...
'    xtotal = Round(xcant * Round(ximporte, 10) - Round(xbonifimporte, 10), 2)
     xtotal = Round((ximportesiva - xbonifimporte) * grilla.TextMatrix(grilla.Row, 11), 3) ' corregido 04/01/2016
...
'--- Calculo de Tem
    xcalculotem = 0
    If UCase(xcalculatempyp) = "S" And xciudadtem = xciudadcliente And DataGrid2.Columns(16).Text <> "CF" And DataGrid2.Columns(16).Text <> "EX" And xcontroltem <> 0 Then
...
'--- Calculo de IIBB
    ...
    If UCase(xcalculaiibb) = "S" And DataGrid2.Columns(16).Text <> "CF" And DataGrid2.Columns(16).Text <> "EX" Then
        ...
        'If xcalculoIIBB <= 50 Then
        '    If Text17.Text <> "" Then
        '        xcontroltotalfactura = (xtotalfactura * xalicuotaiibb / 100) * ((100 - xexentoiibb) / 100)
        '        If xcontroltotalfactura <= 50 Then xcalculoIIBB = 0  ' Limite inferior para calculo de iibb
        '    Else
        '        xcalculoIIBB = 0  ' Limite inferior para calculo de iibb
        '    End If
        'End If
    End If
'--- Fin Calculo IIBB
...
On Error Resume Next
    ...
    datencabezado.RecordSource = "SELECT * From ud_ezi_puntodeventa_encabezado where  numeradorinterno like '%Factura de Venta%'  and  id ='" & Text18.Text & "' "
    datencabezado.Refresh
    If datencabezado.Recordset.EOF = False Then
     xinicio = 1
     xnumeroremito = ""
     xidfactura = datencabezado.Recordset.Fields("claveprimaria")
     xtotalfactura = datencabezado.Recordset.Fields("importeglobal")  ' Nuevo 28/12/2016
     xfechafactura = datencabezado.Recordset.Fields("fechadelcomprobante")  ' Nuevo 28/12/2016
     ...
     If tipofac = "NN" Then frmnota_credito.Caption = "PRESUPUESTO DE VENTA"
     
     mensa = MsgBox("Trae Items de Factura", vbYesNo, "")
     Do While datencabezado.Recordset.EOF = False
        xidpre = datencabezado.Recordset.Fields("id")
        xnumeroremito = datencabezado.Recordset.Fields("tipodefactura") + datencabezado.Recordset.Fields("puntodeventa") + Right("00000000" + datencabezado.Recordset.Fields("numerodefactura"), 8)
'        xidremitovta = datencabezado.Recordset.Fields("idremito")
    ...
    '**** Carga cliente
        ...
        datcliente.Refresh
        If datencabezado.Recordset.Fields("numeradorinterno") = "Factura de Venta Mostrador" Then
            DataCombo3.BoundText = "{e88275fe-0a80-11d6-b0d1-004854841c8a}"
        End If
...
'*** Fin carga Vendedor
        ...
        If mensa = vbYes Then
               ...
               datitems.RecordSource = "SELECT     E.id, E.claveprimaria, IFAC.codigoproducto, IFAC.cantidadproducto, IFAC.unidaddemedidaid, IFAC.preciou, IFAC.listaid, IFAC.bonificacionitem, " & _
                                       "IFAC.importedebonificacion, IFAC.subtotal, IFAC.tipodeentregaitemid, IFAC.nombre_producto, IFAC.iva, IFAC.idproducto, IFAC.idclaveprimariaremito, IFAC.iditemremito, " & _
                                       "IFAC.cantidadproducto AS Cant_Orig, E.alquiler, E.estadoretira  " & _
                                       "FROM         ud_ezi_puntodeventa_encabezado AS E WITH (readpast) RIGHT OUTER JOIN  " & _
                                       "ud_ezi_puntodeventa_detalle_factm AS IFAC WITH (readpast) ON E.id = IFAC.claveprimaria  " & _
                                       "WHERE     (E.claveprimaria = " & xidpre & ") ORDER BY E.id "
...
'            grilla.TextMatrix(X, 5) = Round(datitems.Recordset.Fields("preciou") / ((datitems.Recordset.Fields("iva") + 100) / 100), 2)
            ...
            grilla.TextMatrix(X, 6) = Round((datitems.Recordset.Fields("preciou") / ((datitems.Recordset.Fields("iva") + 100) / 100)) * datitems.Recordset.Fields("cantidadproducto"), 2)
...
'If fe.iniciar(modoFiscal_Test, "20102028245", "mmosse_test.pfx", "") Then
   ...
   If fe.f1ObtenerTicketAcceso() Then
        ...
        If Text1(2).Text = "A" Then
            TipoComp = 3 ' NC A(Ver excel referencias codigos AFIP)
        Else
            TipoComp = 8 ' NC B(Ver excel referencias codigos AFIP)
        End If
...
frmnota_credito.Top = yventana - frmnota_credito.Height / 2
frmnota_credito.Left = xventana - frmnota_credito.Width / 2
...
' On Error GoTo errorgrabar
 ...
 mensa = MsgBox("Desea Grabar esta Nota de Credito ?", vbYesNo, "!! Atención !!")
 If mensa = vbYes Then
...
'On Error GoTo errorgrabar
    ...
    If Round(Text4.Text, 2) > Val(xtotalfactura) And DataCombo3.BoundText = "{E88275FE-0A80-11D6-B0D1-004854841C8A}" Then  ' Nuevo 28/12/2016
        MsgBox "La nota de Credito no puede ser mayor al importe de la Factura", vbCritical, "Error"
        Exit Sub
    End If
    
    If Round(Text4.Text, 2) > xsaldofactura And Text17.Text <> "" Then  ' Nuevo 28/12/2016
        MsgBox "La nota de Credito no puede ser mayor al Saldo de la Factura", vbCritical, "Error"
        Exit Sub
    End If
    
    xemitevalorespago = 0
    If DateValue(xfechafactura) < Date And Text17.Text <> "" And DataCombo3.Text = "01- CONTADO" Then   ' Nuevo 28/12/2016
        MsgBox "La Nota de Credito a emitir tiene fecha distinta a la factura, solo podra egresar valores en Efectivo, en caso de haber registrado otro tipo de valores el egreso de caja lo debe realizar Administración", vbInformation, "Atención"
        xemitevalorespago = 1
    End If
    ...
    datencabezado.Refresh
    datitems.RecordSource = "Select * from ud_ezi_puntodeventa_detalle_notac with(readpast) where id = 0"
    datitems.Refresh
    
    datencabezado.Recordset.AddNew
    datencabezado.Recordset.Fields("claveprimaria") = xclaveprimaria
    datencabezado.Recordset.Fields("numeradorinterno") = "NOTA DE CRÉDITO DE VENTA"
    ...
    datencabezado.Recordset.Fields("estado") = "CTA.CTE"
    ...
    If DataGrid2.Columns("domicilio_id") <> "" Then
    ...
    If Text17.Text = "" Then Text17.Text = 1
    datencabezado.Recordset.Fields("nrofactoriginante") = Text17.Text
    ...
    If datencabezado.Recordset.Fields("tipodefacturacionid") = "MA" Then
      If Text1(2).Text = "A" Then
            xnumerador = "Nota de Credito A (Vta) " + datparametros.Recordset.Fields("sucursal")
      Else
            xnumerador = "Nota de Credito B (Vta) " + datparametros.Recordset.Fields("sucursal")
      End If
    End If
...
'--- Graba Items
    ...
    For X = 1 To xlineasmax
        ...
        If grilla.TextMatrix(X, 7) = "" Then grilla.TextMatrix(X, 7) = 0
        datitems.Recordset.Fields("importedebonificacion") = Round(grilla.TextMatrix(X, 7), 4)
    ...
    If datparametros.Recordset.Fields("FE") = "S" And datencabezado.Recordset.Fields("tipodefacturacionid") <> "CF" Then
...
'******* Graba Pago
    ...
    datpago.Refresh
        ...
        xidpago = datpago.Recordset.Fields("claveprimaria")
...
'******* Graba ud_ezi_cola  y/o Cola importar
    ...
    If datencabezado.Recordset.Fields("tipodefacturacionid") = "CF" Then
        ...
        datcola.Recordset.Fields("accion") = "N" + datencabezado.Recordset.Fields("tipodefactura")
    ...
    Else
        ...
        datcolaimportar.Recordset.Fields("tipodedocumentoid") = datparametros.Recordset.Fields("idnotacredito")
...
''' Libera Remito de Factura

    datcola.RecordSource = "select * from ud_ezi_puntodeventa_detalle_factm where claveprimaria = " & xidfactura & ""
    datcola.Refresh
    If datcola.Recordset.EOF = False Then
        datcola.Recordset.MoveFirst
        Do While Not datcola.Recordset.EOF
            datcola.Recordset.Fields("idclaveprimariaremito") = Null
            datcola.Recordset.UpdateBatch adAffectCurrent
            datcola.Recordset.MoveNext
        Loop
    End If
...
If 1 = 2 Then  '' Comentado para Mosse
'******** Genera Documento de Egreso en el caso de ser Nota de Credito de Contado Nuevo 28/12/2016
If DataCombo3.BoundText = "{E88275FE-0A80-11D6-B0D1-004854841C8A}" Then    ' Nota de Credito de Contado
           
  datpago.RecordSource = "Select * from ud_ezi_pago where claveprimaria = '" & xidfactura & "'"  ' Nuevo 28/12/2016
  datpago.Refresh
  xcontroldevalores = 0
  If datpago.Recordset.EOF = False Then
          

          Do While Not datpago.Recordset.EOF
                   xcontroltipopago = datpago.Recordset.Fields("formadepago")
                   If xcontroltipopago <> "Efectivo" And xemitevalorespago = 1 Then xcontroldevalores = 1
                   datpago.Recordset.MoveNext
          Loop
  End If
    
  If xcontroldevalores = 0 Then  '  Nuevo 28/12/2016
    datencabezado.RecordSource = "SELECT MAX(CONVERT(decimal, isnull(claveprimaria,0))) AS claveprimaria FROM ud_ezi_puntodeventa_encabezado with(readpast)"
    datencabezado.Refresh
    ...
    datencabezado.Recordset.Fields("fechadelcomprobante") = DateValue(Text3.Text) + TimeValue(Str(Time))
    datencabezado.Recordset.Fields("detalle") = "Egreso por NC de Contado"
    datencabezado.Recordset.Fields("sucursal") = datparametros.Recordset.Fields("sucursal")
    datencabezado.Recordset.Fields("cotizacion") = 1
    ...
    datencabezado.Recordset.Fields("generada") = "True"
    datencabezado.Recordset.Fields("importado") = "False"
' Descomentar para base Prueba     datencabezado.Recordset.Fields("clienteid") = "{0E989326-2D33-4057-AA89-29E4CB30218A}" ' Base de Prueba Imputacion Ajuste de Contado
    datencabezado.Recordset.Fields("clienteid") = "{79D37C12-F4C5-4EEA-811D-D80F8869D608}" ' Base Real Imputacion Ajuste de Contado
    ...
    '** Establene numero de Facturas Manuales, y no Fiscales egreso NC Contado
    ...
    '** Fin de asignacion de numero a Factura egreso NC Contado

    datencabezado.Recordset.Fields("claveprimaria") = xid
    datencabezado.Recordset.UpdateBatch adAffectCurrent
    
    
    '******* Graba Pago egreso NC Contado

    datpago.RecordSource = "Select * from ud_ezi_pago where claveprimaria = '" & xidfactura & "'"
    datpago.Refresh
    datcola.RecordSource = "Select * from ud_ezi_pago where claveprimaria = ''"
    datcola.Refresh
    xtotalpago = 0
    If datpago.Recordset.EOF = False Then
          
          Do While Not datpago.Recordset.EOF
                   xtotalpago = datpago.Recordset.Fields("monto") + xtotalpago
                   datpago.Recordset.MoveNext
          Loop
    ...
    Do While Not datpago.Recordset.EOF
      If datpago.Recordset.Fields("formadepago") = "Efectivo" Then
        datcola.Recordset.AddNew
        datcola.Recordset.Fields("claveprimaria") = xid
        datcola.Recordset.Fields("tipovalor") = "True"
        datcola.Recordset.Fields("valoroseniaid") = datpago.Recordset.Fields("valoroseniaid")
        datcola.Recordset.Fields("destinoid") = datparametros.Recordset.Fields("cajadefecto")
        datcola.Recordset.Fields("formadepago") = datpago.Recordset.Fields("formadepago")
        datcola.Recordset.Fields("monto") = -Round(Text4.Text, 2)
        datcola.Recordset.Fields("importeegresa") = Round(Text4.Text, 2)
        datcola.Recordset.Fields("idimputacion") = datencabezado.Recordset.Fields("clienteid")
        datcola.Recordset.Fields("imputacion") = "Ajuste Venta de Contado"
        datcola.Recordset.Fields("caja") = 1
       Else
        If xemitevalorespago = 0 Then
         datcola.RecordSource = "select * from ud_ezi_pago with (readpast) where id = " & datpago.Recordset.Fields("id") & ""
         datcola.Refresh

         datcola.Recordset.Fields("importeegresa") = datpago.Recordset.Fields("monto")
         datcola.Recordset.Fields("transferido") = 1
         datcola.Recordset.Fields("claveprimaria2") = xid
         datcola.Recordset.Fields("fechacierrre") = DateValue(Text3.Text) + TimeValue(Str(Time))
         datcola.Recordset.Fields("idtransferencia") = xnrocierre
         datcola.Recordset.Fields("usuario") = login.usuarioactivo

        End If
       End If

      
        datcola.Recordset.Fields("idimputacionegreso") = datencabezado.Recordset.Fields("clienteid")
        datcola.Recordset.Fields("imputacionegreso") = "Ajuste Venta de Contado"
        datcola.Recordset.Fields("sucursal") = login.nomsucursal
    ...
    '******* Graba ud_ezi_cola egreso NC Contado
  ...
  End If
End If
End If '''' Fin de genera egreso en caso de ser Nota de credito de contado


    If datencabezado.Recordset.Fields("tipodefacturacionid") <> "CF" Then
        Call imprimefactura_Click 'Descomentar cuando haya informe manual
    End If
...
reporte.SQL = "SELECT v_ezi_pos_notac.id, v_ezi_pos_notac.NUMERODOCUMENTO, v_ezi_pos_notac.FECHAEMISION, v_ezi_pos_notac.cod_cliente, v_ezi_pos_notac.cliente, v_ezi_pos_notac.CUIT, v_ezi_pos_notac.CALLE, v_ezi_pos_notac.CODPOS, v_ezi_pos_notac.provincia, v_ezi_pos_notac.detalle, v_ezi_pos_notac.tipopago, v_ezi_pos_notac.codigoproducto, v_ezi_pos_notac.nombre_producto, v_ezi_pos_notac.cantidadproducto, v_ezi_pos_notac.nota, v_ezi_pos_notac.condiva, v_ezi_pos_notac.ciudad, v_ezi_pos_notac.TIPOVENTA, v_ezi_pos_notac.SIMBOLO, v_ezi_pos_notac.CODVENDEDOR, v_ezi_pos_notac.preciusiniva, v_ezi_pos_notac.subtotalsiniva, v_ezi_pos_notac.impbonifsiniva, v_ezi_pos_notac.nroremito, v_ezi_pos_notac.percepiibb, v_ezi_pos_notac.perceptem, v_ezi_pos_notac.totaltr, v_ezi_pos_notac.importeiva21, v_ezi_pos_notac.importeiva105, v_ezi_pos_notac.iditem " & _
              "FROM  MMOSSE.dbo.v_ezi_pos_notac v_ezi_pos_notac " & _
              "where v_ezi_pos_notac.id = " & xid & " order by v_ezi_pos_notac.iditem"
...
If KeyAscii = 13 Then
        KeyAscii = 0
'        If grilla.Col = 3 And Text2.Text > grilla.Text Then
'          If remdev = 1 Then
