...
Begin VB.Form bases 
   ...
   Begin MSAdodcLib.Adodc datproductos 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "select prod.* from prod"
      Caption         =   "Adodc1"
      ...
      _Version        =   393216
   End
   Begin MSAdodcLib.Adodc datbasemenu 
      Height          =   330
      Left            =   120
      Top             =   360
      Width           =   1200
      ...
      _Version        =   393216
   End
   Begin MSAdodcLib.Adodc datbasemenu1 
      Height          =   330
      Left            =   120
      Top             =   720
      Width           =   1200
   ...
   Begin MSAdodcLib.Adodc datempresa 
      ...
      _Version        =   393216
   End
   Begin MSAdodcLib.Adodc datbasemenu2 
      Height          =   330
      Left            =   120
      Top             =   1080
      Width           =   1200
