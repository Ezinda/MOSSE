...
Begin VB.Form impordeneslistado 
   ...
   ClientTop       =   435
   ClientWidth     =   6210
   Icon            =   "impordeneslistado.frx":0000
   LinkTopic       =   "From1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin vbskpro.Skinner Skinner1 
      ...
      LcK2            =   $"impordeneslistado.frx":0442
      AmbientB        =   ";<=>?7B:><7=<A<7CC;@"
   ...
   Begin KewlButtonz.KewlButtons listar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "impordeneslistado.frx":0451
      PICN            =   "impordeneslistado.frx":046D
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
