...
Begin VB.Form frmremitosconsulta_alquiler 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Consulta de Remitos de Alquiler"
   ClientHeight    =   7440
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   15195
   Icon            =   "frmremitosconsulta_alquiler.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   7440
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmremitosconsulta_alquiler.frx":0442
      Height          =   2775
      Left            =   120
      TabIndex        =   4
      Top             =   1080
   ...
   Begin VB.Frame Frame2 
      ...
      Begin KewlButtonz.KewlButtons Command4 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmremitosconsulta_alquiler.frx":045B
         PICN            =   "frmremitosconsulta_alquiler.frx":0477
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmremitosconsulta_alquiler.frx":3869
         PICN            =   "frmremitosconsulta_alquiler.frx":3885
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "frmremitosconsulta_alquiler.frx":43CF
      Height          =   2775
      Left            =   120
      TabIndex        =   10
      TabStop         =   0   'False
   ...
   Begin KewlButtonz.KewlButtons facturar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmremitosconsulta_alquiler.frx":43EB
      PICN            =   "frmremitosconsulta_alquiler.frx":4407
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons KewlButtons1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmremitosconsulta_alquiler.frx":49A1
      PICN            =   "frmremitosconsulta_alquiler.frx":49BD
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmremitosconsulta_alquiler"
...
Else
    xquery = "SELECT  R.id, R.referenciaproducto AS Codigo, R.nombre_producto AS Descipcion, R.cantidadoriginal AS Cant_Orig, R.cantidadremitida AS Cant_Remitida, " & _
             ...
             "v_ezi_pos_remito AS R ON IFAC.iditemremito = R.iditem " & _
             "GROUP BY R.id, R.referenciaproducto, R.nombre_producto, R.cantidadoriginal, R.cantidadremitida, R.unidaddemedida, R.iditem " & _
             "Having R.id = " & DataGrid1.Columns(0).Text & " and (R.cantidadoriginal > ISNULL(SUM(IFAC.cantidadproducto), 0)) ORDER BY R.iditem"
End If
...
frmremitosconsulta_alquiler.Top = yventana - frmremitosconsulta_alquiler.Height / 2
frmremitosconsulta_alquiler.Left = xventana - frmremitosconsulta_alquiler.Width / 2
...
xquery1 = "SELECT     id, Sel, NroRemito, Fecha, CodCliente, Cliente, CUIT, Vendedor, Tipopago, TipodeVenta, presupuestobase, MAX(NroFactura) AS NroFactura, MAX(cantremitida) " & _
          ...
          "E.tipodefactura + ' ' + E.puntodeventa + RIGHT('0000000' + E.numerodefactura, 8) AS NroFactura, R.tipopago AS Tipopago, R.TIPOVENTA AS TipodeVenta, R.presupuestobase, " & _
          "R.vendedor AS Vendedor, max(R.cantidadremitida) AS cantremitida, " & _
        ...
        If Text1.Text <> "" Then
            ...
            If Option4.Value = True Then
                xquery1 = "SELECT id, Sel, NroRemito, Fecha, CodCliente, Cliente, CUIT,  MAX(NroFactura) AS NroFactura, Tipopago, TipodeVenta, presupuestobase,Vendedor, MAX(cantremitida) " & _
                          ...
                          "HAVING (R.alquiler = 'S') and (R.NUMERODOCUMENTO + 'r  ' + R.cliente + ' ' + R.CUIT + ' ' + ISNULL(E.tipodefactura + ' ' + E.puntodeventa + RIGHT('0000000' + E.numerodefactura, 8), '') + 'f' LIKE '" & xbusqueda & "')) AS RC " & _
                          "GROUP BY id, Sel, NroRemito, Fecha, CodCliente, Cliente, CUIT, Vendedor, Tipopago, TipodeVenta, presupuestobase " & _
                          "Having (Max(cantremitida) > SUM(cantfacturada)) ORDER BY id DESC"
