...
Begin VB.Form lista_notacredito_todas 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "lista_notacredito_todas.frx":0000
         PICN            =   "lista_notacredito_todas.frx":001C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons Command4 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "lista_notacredito_todas.frx":0B66
         PICN            =   "lista_notacredito_todas.frx":0B82
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "lista_notacredito_todas.frx":3F74
      Height          =   6855
      Left            =   120
      TabIndex        =   0
      Top             =   1560
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "lista_notacredito_todas.frx":3F91
      Height          =   1215
      Left            =   120
      TabIndex        =   1
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "lista_notacredito_todas"
...
If Text1.Text = "" Then
        xquery1 = "SELECT     ud_ezi_puntodeventa_encabezado.claveprimaria AS Numero, ud_ezi_puntodeventa_encabezado.numerodefactura AS Nro, " & _
          ...
          "AS concatenado, ud_ezi_puntodeventa_encabezado.alquiler, pvf.puntodeventa + RIGHT('00000000' + pvf.numerodefactura, 8) AS nrofactura " & _
          "FROM         ud_ezi_puntodeventa_encabezado AS pvf RIGHT OUTER JOIN " & _
          "ud_ezi_puntodeventa_encabezado WITH (readpast) ON pvf.id = ud_ezi_puntodeventa_encabezado.presupuestobase LEFT OUTER JOIN " & _
          ...
          "V_CLIENTE_ ON V_PERSONA_.ID = V_CLIENTE_.ENTEASOCIADO_ID ON ud_ezi_puntodeventa_encabezado.clienteid = V_CLIENTE_.ID " & _
                      "WHERE     (ud_ezi_puntodeventa_encabezado.numeradorinterno like '%NOTA DE CRÉDITO DE VENTA%') and (ud_ezi_puntodeventa_encabezado.tipodefacturacionid <> 'NN') and ud_ezi_puntodeventa_encabezado.sucursal = '" & xsuc & "' and " & _
...
Else
            xquery1 = "SELECT     ud_ezi_puntodeventa_encabezado.claveprimaria AS Numero, ud_ezi_puntodeventa_encabezado.numerodefactura AS Nro, " & _
                     ...
                     "V_CLIENTE_ ON V_PERSONA_.ID = V_CLIENTE_.ENTEASOCIADO_ID ON ud_ezi_puntodeventa_encabezado.clienteid = V_CLIENTE_.ID " & _
                     "WHERE     (ud_ezi_puntodeventa_encabezado.numeradorinterno like '%NOTA DE CRÉDITO DE VENTA%') and (ud_ezi_puntodeventa_encabezado.tipodefacturacionid <> 'NN') and ud_ezi_puntodeventa_encabezado.sucursal = '" & xsuc & "' and " & _
                     "(ud_ezi_puntodeventa_encabezado.numerodefactura + 'n ' + ud_ezi_puntodeventa_encabezado.cliente + ' ' + V_PERSONA_.CUIT + ' ' + ud_ezi_puntodeventa_encabezado.vendedor like '" & xbusqueda & "') and " & _
                     "(ud_ezi_puntodeventa_encabezado.fechadelcomprobante >= '" & DesdeFecha.Value & "') and " & _
                     "(ud_ezi_puntodeventa_encabezado.fechadelcomprobante < '" & HastaFecha.Value + 1 & "') " & _
                     "ORDER BY Fecha DESC"
End If
...
If Text1.Text = "" Then
 reporte.SQL = "SELECT     Numero, tipodefactura, fechadelcomprobante, numeradorinterno, codcliente, cliente, totaltr, NroRemito " & _
              "FROM         MMOSSE.dbo.v_ezi_pos_listadonotacredito AS v_ezi_pos_listadonotacredito " & _
              "WHERE     convert(date,v_ezi_pos_listadonotacredito.fechadelcomprobante) >= '" & DesdeFecha.Value & "' and " & _
              "convert(date,v_ezi_pos_listadonotacredito.fechadelcomprobante) <= '" & HastaFecha.Value & "' and " & _
              "v_ezi_pos_listadonotacredito.sucursal = '" & login.nomsucursal & "' " & _
...
Else
 reporte.SQL = "SELECT     Numero, tipodefactura, fechadelcomprobante, numeradorinterno, codcliente, cliente, totaltr, NroRemito " & _
              ...
              "WHERE     convert(date,v_ezi_pos_listadonotacredito.fechadelcomprobante) >= '" & DesdeFecha.Value & "' and " & _
              "convert(date,v_ezi_pos_listadonotacredito.fechadelcomprobante) <= '" & HastaFecha.Value & "' and " & _
              "v_ezi_pos_listadonotacredito.sucursal = '" & login.nomsucursal & "' and " & _
              "v_ezi_pos_listadonotacredito.cliente = '" & DataGrid1.Columns("cliente").Text & "' " & _
              "order by fechadelcomprobante desc"
End If
...
With CrystalReporte
    .PrinterCollation = crptCollated
    .ReportFileName = App.Path & "\Reporte_listado_notacredito.rpt"
...
datcomp.RecordSource = "SELECT distinct ud_ezi_puntodeventa_encabezado.claveprimaria AS Numero, ud_ezi_puntodeventa_encabezado.numerodefactura AS Nro, " & _
                       "ud_ezi_puntodeventa_encabezado.fechadelcomprobante AS Fecha, ud_ezi_puntodeventa_encabezado.cliente AS Cliente, V_PERSONA_.CUIT,  " & _
                       "ud_ezi_puntodeventa_encabezado.vendedor AS Vendedor, ud_ezi_puntodeventa_encabezado.importeglobal AS Importe, ud_ezi_puntodeventa_encabezado.id,  " & _
                       "ud_ezi_puntodeventa_encabezado.generada, ud_ezi_puntodeventa_encabezado.tipodefactura, " & _
                       "ud_ezi_puntodeventa_encabezado.numerodefactura + 'n ' + ud_ezi_puntodeventa_encabezado.cliente + ' ' + V_PERSONA_.CUIT + ' ' + ud_ezi_puntodeventa_encabezado.vendedor " & _
                       ...
                       "ud_ezi_puntodeventa_encabezado.totaliva, ud_ezi_puntodeventa_encabezado.responsabilidad, v_ezi_pos_iva_notac.importeiva21, " & _
                       "v_ezi_pos_iva_notac.importeiva105 , isnull(ud_ezi_puntodeventa_encabezado.nroorden,'') as nroorden, ud_ezi_puntodeventa_encabezado.fechaorden, " & _
                       "ud_ezi_puntodeventa_encabezado.percepiibb , ud_ezi_puntodeventa_encabezado.perceptem " & _
                       "FROM         v_ezi_pos_iva_notac RIGHT OUTER JOIN " & _
                       "ud_ezi_puntodeventa_encabezado WITH (readpast) ON v_ezi_pos_iva_notac.id = ud_ezi_puntodeventa_encabezado.id LEFT OUTER JOIN " & _
                       ...
                       "V_PERSONA_ RIGHT OUTER JOIN " & _
                       "V_CLIENTE_ ON V_PERSONA_.ID = V_CLIENTE_.ENTEASOCIADO_ID ON ud_ezi_puntodeventa_encabezado.clienteid = V_CLIENTE_.ID " & _
                       "WHERE     (ud_ezi_puntodeventa_encabezado.numeradorinterno LIKE '%Nota de Crédito%') AND (ud_ezi_puntodeventa_encabezado.tipodefacturacionid <> 'NN') AND " & _
...
' Iva 21
   ...
   If Round(datcomp.Recordset.Fields("importeiva21"), 2) <> 0 Then
     ...
     If Round(datcomp.Recordset.Fields("importeiva105"), 2) <> 0 <> 0 Then
   ...
   '   If Round(datcomp.Recordset.Fields("importeiva21"), 2) - xtotaliva <> 0 Then
   '     xbaseiva21 = xbaseiva21 - (Round(datcomp.Recordset.Fields("importeiva21"), 2) - xtotaliva)
...
Option1.Value = True
lista_notacredito_todas.Top = yventana - lista_notacredito_todas.Height / 2
lista_notacredito_todas.Left = xventana - lista_notacredito_todas.Width / 2
