...
Begin VB.Form frmalquiler 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "REMITO DE ALQUILER DE BIENES"
   ClientHeight    =   8610
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   15195
   Icon            =   "frmalquiler.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin KewlButtonz.KewlButtons buscar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmalquiler.frx":0448
         PICN            =   "frmalquiler.frx":0464
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmalquiler.frx":09F6
         PICN            =   "frmalquiler.frx":0A12
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons grabar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmalquiler.frx":155C
         PICN            =   "frmalquiler.frx":1578
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmalquiler.frx":2FFA
         PICN            =   "frmalquiler.frx":3016
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CheckBox Check1 
         Caption         =   "Emite Factura Inmediatamente"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin KewlButtonz.KewlButtons bclientes 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmalquiler.frx":3A5B
         PICN            =   "frmalquiler.frx":3A77
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons bvendedor 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmalquiler.frx":4011
         PICN            =   "frmalquiler.frx":402D
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons agregaproducto 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmalquiler.frx":45FF
         PICN            =   "frmalquiler.frx":461B
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons KewlButtons1 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmalquiler.frx":4BB5
         PICN            =   "frmalquiler.frx":4BD1
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
...
Private Sub cargapresupuesto_Click()
    ...
    datencabezado.RecordSource = "SELECT * From ud_ezi_puntodeventa_encabezado where  numeradorinterno = 'Presupuesto de Venta' and  claveprimaria ='" & Text17.Text & "' and generada = 'False'"
...
frmalquiler.Top = yventana - frmalquiler.Height / 2
frmalquiler.Left = xventana - frmalquiler.Width / 2
...
Text1(8).Text = "ALQUILER DE BIENES"
...
'    If UCase(datparametros.Recordset.Fields("cobroautomatico")) = "S" And DataCombo3.Text = "CONTADO" Then
'        frmcobranzacdo.Show
...
'    datencabezado.Recordset.Fields("bonificacion") = Round(Text11.Text, 2)
    ...
    Else
       If Text1(10).Text = "" Then
        ...
        datcolaimportar.Recordset.UpdateBatch adAffectCurrent
       Else
         datencabezado.Recordset.Fields("numerodefactura") = Text1(10).Text
...
'--- Graba Items
    ...
    For X = 1 To xlineasmax
        ...
        datitems.Recordset.Fields("nombre_producto") = grilla.TextMatrix(X, 2)
        datitems.Recordset.Fields("cantidadoriginal") = grilla.TextMatrix(X, 11)
        datitems.Recordset.Fields("cantidadremitida") = grilla.TextMatrix(X, 11)
        datitems.Recordset.Fields("cantidadaremitir") = grilla.TextMatrix(X, 11)
        If grilla.TextMatrix(X, 11) = "" Or grilla.TextMatrix(X, 11) = "0" Then grilla.TextMatrix(X, 11) = "1"
        datitems.Recordset.Fields("cantentregada") = grilla.TextMatrix(X, 11)
...
'*** Graba iditem de remito en Items de Nota de Venta
    ...
    For X = 1 To xlineasmax
        ...
        datitemsnv.Recordset.Fields("iditemremito") = grilla.TextMatrix(X, 15)
...
'******* Graba ud_ezi_cola  y/o Cola importar
 ' If Text1(10).Text <> "" Then     ' Sacar para el funcionamiento normal
    If datencabezado.Recordset.Fields("tipodefacturacionid") = "CF" Then
        datcolaimportar.RecordSource = "select * from ud_ezi_cola where nombrepc = '1'"
        datcolaimportar.Refresh
    ...
    End If
  ' End If  ' sacar para el funcionamiento normal
''**** Imprime remito
    If tipofac <> "NN" Then
...
If datparametros.Recordset.Fields("imprimemanual") = "N" Or Text1(10).Text <> "" Then Exit Sub
