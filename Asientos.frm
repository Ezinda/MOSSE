...
Begin VB.Form Asientos 
   Caption         =   "Maestro Asientos"
   ClientHeight    =   4605
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   8640
   ...
   Begin MSAdodcLib.Adodc datPrimaryRS 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   "PROVIDER=MSDataShape;Data PROVIDER=MSDASQL;dsn=contable;uid=sa;pwd=;database=contablesql;"
      OLEDBString     =   "PROVIDER=MSDataShape;Data PROVIDER=MSDASQL;dsn=contable;uid=sa;pwd=;database=contablesql;"
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
      Password        =   ""
      RecordSource    =   $"Asientos.frx":0000
      Caption         =   " "
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
...
Private Sub Form_Load()
 Rem Set grdDataGrid.DataSource = datPrimaryRS.Recordset("ChildCMD").UnderlyingValue
  
  txtFields(6) = login.empresaact
