...
Begin VB.Form importalibroasientos 
   ...
   Begin MSDataListLib.DataList DataList3 
      Bindings        =   "importalibroasiento.frx":0000
      Height          =   1620
      Left            =   840
      TabIndex        =   52
      Top             =   3480
   ...
   Begin MSDataListLib.DataList DataList2 
      Bindings        =   "importalibroasiento.frx":0019
      Height          =   2205
      Left            =   1080
      TabIndex        =   28
      Top             =   3480
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "importalibroasiento.frx":0032
      Height          =   2175
      Left            =   240
      TabIndex        =   22
      Top             =   3720
   ...
   Begin vbskpro.Skinner Skinner1 
      ...
      LcK2            =   $"importalibroasiento.frx":004B
      AmbientB        =   ";<=>?7B:><7=<A<7CC;@"
   ...
   End
End
Attribute VB_Name = "importalibroasientos"
...
Rem If datasiento.Recordset.EOF = False Then
Rem    datasiento.Recordset.MoveFirst
Rem Do While Not datasiento.Recordset.EOF
   
Rem   datasiento.Recordset.Delete
Rem datasiento.Recordset.MoveNext
Rem Loop
Rem End If
Rem    datasiento.RecordSource = "select [Detalle Asientos].* from [Detalle Asientos] where empresa = " & login.empresaact & " order by idmasterasientos"
Rem    datasiento.Refresh
    Call nuevo0_Click
...
Rem   datasiento.Recordset.AddNew

Rem   Text3(1).Text = login.empresaact
Rem   Text3(2).Text = MaskEdBox1.Text
Rem   Text3(8).Text = Text2.Text
Rem   Text5.Text = Date
...
Private Sub nuevo0_Click()
    ...
    Text5.Text = Date
    Text1(2).Text = "Cobranzas mes de " + importalibroventas.Combo1.Text
...
Private Sub Text1_KeyPress(Index As Integer, KeyAscii As Integer)
    ...
    If KeyAscii = 13 Or KeyAscii = 9 Then
        ...
        errorfecha = 0
        Call grabar_Click
        If errorfecha = 1 Then Exit Sub
            datasiento.Recordset.AddNew
            Text4.Text = 62
            Text3(4).Text = importalibroventas.Text8(0).Value
            Text3(5).Text = 0
            Text3(6).Text = "Total Facturado"
            Text3(1).Text = login.empresaact
            Text3(2).Text = MaskEdBox1.Text
            Text3(8).Text = Text2.Text
            Text5.Text = Date
            ...
            Text4.Text = 44
            Text3(4).Text = 0
            Text3(5).Text = Val(importalibroventas.Text8(1).Text) + Val(importalibroventas.Text8(5).Text)
            Text3(6).Text = "Serv. Nivel Pri.e Inic."
            Text3(1).Text = login.empresaact
            Text3(2).Text = MaskEdBox1.Text
            Text3(8).Text = Text2.Text
            Text5.Text = Date
            ...
            Text4.Text = 46
            Text3(4).Text = 0
            Text3(5).Text = Val(importalibroventas.Text8(2).Text)
            Text3(6).Text = "Serv. Nivel Medio"
            Text3(1).Text = login.empresaact
            Text3(2).Text = MaskEdBox1.Text
            Text3(8).Text = Text2.Text
            Text5.Text = Date
            ...
            Text4.Text = 411
            Text3(4).Text = 0
            Text3(5).Text = Val(importalibroventas.Text8(3).Text)
            Text3(6).Text = "Serv. Nivel Terciario"
            Text3(1).Text = login.empresaact
            Text3(2).Text = MaskEdBox1.Text
            Text3(8).Text = Text2.Text
            Text5.Text = Date
            ...
            Text4.Text = 413
            Text3(4).Text = 0
            Text3(5).Text = Val(importalibroventas.Text8(4).Text)
            Text3(6).Text = "Serv. Nivel Universitario"
            Text3(1).Text = login.empresaact
            Text3(2).Text = MaskEdBox1.Text
            Text3(8).Text = Text2.Text
            Text5.Text = Date
