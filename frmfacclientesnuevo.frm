...
Begin VB.Form frmfacclientesnuevo 
   ...
   ClientTop       =   330
   ClientWidth     =   10185
   Icon            =   "frmfacclientesnuevo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmfacclientesnuevo.frx":0442
         PICN            =   "frmfacclientesnuevo.frx":045E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons facturar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmfacclientesnuevo.frx":0FA8
         PICN            =   "frmfacclientesnuevo.frx":0FC4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   120
      Width           =   1695
      Begin KewlButtonz.KewlButtons notacredito 
         Height          =   735
         Left            =   240
         TabIndex        =   38
         Top             =   1080
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmfacclientesnuevo.frx":43B6
         PICN            =   "frmfacclientesnuevo.frx":43D2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
         ...
         VALUE           =   0   'False
      End
      Begin KewlButtonz.KewlButtons notadebito 
         Height          =   735
         Left            =   240
         TabIndex        =   39
         Top             =   1800
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmfacclientesnuevo.frx":AC34
         PICN            =   "frmfacclientesnuevo.frx":AC50
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons factura 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmfacclientesnuevo.frx":114B2
         PICN            =   "frmfacclientesnuevo.frx":114CE
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmfacclientesnuevo.frx":27D93
         PICN            =   "frmfacclientesnuevo.frx":27DAF
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.OptionButton Option2 
         Caption         =   "F-ND-NC Dist Numeración"
         Height          =   195
         Left            =   3000
         TabIndex        =   87
         Top             =   240
      ...
      Begin VB.OptionButton Option1 
         Caption         =   "F-ND-NC Misma Numeración"
         Height          =   195
         Left            =   3000
         TabIndex        =   86
         Top             =   0
      ...
      Begin MSDataListLib.DataList DataList3 
         Bindings        =   "frmfacclientesnuevo.frx":287C1
         Height          =   1035
         Left            =   1680
         TabIndex        =   23
         Top             =   1680
      ...
      Begin MSDataListLib.DataList DataList1 
         Bindings        =   "frmfacclientesnuevo.frx":287DB
         Height          =   1815
         Left            =   1080
         TabIndex        =   20
         Top             =   960
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmfacclientesnuevo.frx":287F5
         Height          =   315
         Left            =   2160
         TabIndex        =   29
         Top             =   2880
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmfacclientesnuevo.frx":28810
         Height          =   375
         Left            =   8040
         TabIndex        =   31
         Top             =   1080
   ...
   Begin MSDataListLib.DataList DataList2 
      Bindings        =   "frmfacclientesnuevo.frx":2882A
      Height          =   1815
      Left            =   600
      TabIndex        =   2
      Top             =   4080
   ...
   Begin MSDataGridLib.DataGrid DataGrid3 
      Bindings        =   "frmfacclientesnuevo.frx":28849
      Height          =   375
      Left            =   5880
      TabIndex        =   3
      Top             =   4200
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmfacclientesnuevo.frx":28864
      Height          =   2055
      Left            =   240
      TabIndex        =   41
      Top             =   3720
   ...
   Begin vbskpro.Skinner Skinner1 
      ...
      LcK2            =   $"frmfacclientesnuevo.frx":28881
      AmbientB        =   ";<=>?7B:><7=<A<7CC;@"
   ...
   End
End
Attribute VB_Name = "frmfacclientesnuevo"
...
Private Sub buscafact_Click()
 ...
 If Option2.Value = True Then
     datprimaryrs.RecordSource = "select libroventas.* from libroventas WHERE libroventas.empresa = " & login.empresaact & " and tipocompr = '" & Text6.Text & "' and numcompr >= '" & puntoventa & "' and numcompr < '" & puntofinal1 & "' Order by numcompr"
...
Text9.Text = 0
If Text6.Text = "F-B" Or Text6.Text = "NCB" Or Text6.Text = "NDB" Then
    For x = 0 To datfacclientes.Recordset.RecordCount - 1
      For Y = 1 To 15
...
For x = datfacclientes.Recordset.RecordCount To 50
 For Y = 1 To 15
     totalparcial(x, Y) = 0
     totalalicuota(x, Y) = 0
 Next Y
...
Private Sub DataGrid1_AfterColEdit(ByVal ColIndex As Integer)
 ...
 Rem   DataGrid1.Columns(8).Text = DataGrid3.Columns(3).Text
    If DataGrid1.Col = 8 Or DataGrid1.Col = 5 Then
        DataGrid1.Columns(9).Text = Val(DataGrid1.Columns(8).Value) * Val(DataGrid1.Columns(5).Value)
    End If
    ...
    End If
        ...
        If DataGrid1.Columns(9).Text = "" Then DataGrid1.Columns(9).Text = "0"
...
Private Sub DataGrid1_AfterUpdate()
    ...
    If DataGrid1.Col = 16 Then
         ...
         totalparcial(datfacclientes.Recordset.AbsolutePosition - 1, collib) = datfacclientes.Recordset.Fields("totalneto")
         ...
         totalalicuota(datfacclientes.Recordset.AbsolutePosition - 1, collib) = datfacclientes.Recordset.Fields("gravado")
         Call calcula_Click
    End If
...
If ColIndex = 4 Then
        ...
        DataList2.Width = DataGrid1.Columns(4).Width * 6
...
Rem fin busca
            collibro(datfacclientes.Recordset.AbsolutePosition) = collib
...
Rem *********** fin verifica cod contable del cliente **********
        ...
        If DataGrid2.Columns(5).Text <> "" Then Text4.Text = DataGrid2.Columns(5).Text
...
Private Sub factura_Click()
    ...
    Text6.Text = "F-" + Right(Text6.Text, 1)
    factura.Enabled = False
    notadebito.Enabled = False
    notacredito.Enabled = False
...
mensaerror = ""
    ...
    If Text1.Text = "" Then
        MsgBox "Debe ingresar un cliente Valido", vbCritical, "Error"
        Text1.SetFocus
        Exit Sub
    End If
...
Next x
    ...
    login.datpuntos.RecordSource = "select puntosdeventas.* from puntosdeventas where empresa = " & login.empresaact & " and puntodeventa = '" & Combo1.Text & "' "
    login.datpuntos.Refresh
    imprime(0) = login.datpuntos.Recordset.Fields("imprime")
    Call Form_Load
    DataGrid1.Enabled = False
     
     

    If imprime(0) = True Then Call Command4_Click
    Maskfecha.SetFocus

Exit Sub

fuera:
    MsgBox "Error " + mensaerror, vbCritical, "Atencion"

End Sub

Private Sub Form_Load()
On Error GoTo errorfactu
Aplicar_skin Me

Option2.Value = True
frmfacclientesnuevo.Top = 0
frmfacclientesnuevo.Left = 0
...
End If
    ...
    data1.Connection1.Execute ("delete facclientes from facclientes where empresa = " & login.empresaact & " and facturado = 'N' and numdisco = " & s & " ")
...
Private Sub notacredito_Click()
    ...
    notacredito.Enabled = False
    DataGrid1.Enabled = True
    If Option2.Value = True Then Call buscafact_Click
    DataGrid1.SetFocus
