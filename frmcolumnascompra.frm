...
Begin VB.Form frmcolumnascompra 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Configuración Columnas Libro Compras"
   ClientHeight    =   7592
   ClientLeft      =   1092
   ClientTop       =   325
   ClientWidth     =   10374
   Icon            =   "frmcolumnascompra.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin MSDataListLib.DataList DataList2 
      Bindings        =   "frmcolumnascompra.frx":0442
      Height          =   2595
      Left            =   3240
      TabIndex        =   89
      Top             =   4320
   ...
   Begin VB.CommandButton salir 
      ...
      Height          =   615
      Left            =   4920
      Picture         =   "frmcolumnascompra.frx":045B
      Style           =   1  'Graphical
      TabIndex        =   50
      Top             =   6480
      UseMaskColor    =   -1  'True
   ...
   Begin VB.CommandButton grabar 
      ...
      Height          =   615
      Left            =   3480
      Picture         =   "frmcolumnascompra.frx":089D
      Style           =   1  'Graphical
      TabIndex        =   49
      Top             =   6480
      UseMaskColor    =   -1  'True
   ...
   Begin vbskpro.Skinner Skinner1 
      ...
      LcK2            =   $"frmcolumnascompra.frx":0DCF
      AmbientB        =   ";<=>?7B:><7=<A<7CC;@"
   ...
   End
End
Attribute VB_Name = "frmcolumnascompra"
...
datPrimaryRS.ConnectionString = login.conexiontotal
    ...
    datPrimaryRS.RecordSource = "SELECT columnascompra.* FROM columnascompra where empresa = " & login.empresaact & " and inicioper = '" & login.iper & "' and finper = '" & login.fper & "'"
