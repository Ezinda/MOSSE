...
Begin VB.Form frmnota_debito 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin KewlButtonz.KewlButtons buscar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_debito.frx":0442
         PICN            =   "frmnota_debito.frx":045E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_debito.frx":09F0
         PICN            =   "frmnota_debito.frx":0A0C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons grabar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_debito.frx":1556
         PICN            =   "frmnota_debito.frx":1572
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_debito.frx":2FF4
         PICN            =   "frmnota_debito.frx":3010
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSDataListLib.DataCombo DataCombo3 
         Bindings        =   "frmnota_debito.frx":3A22
         Height          =   360
         Left            =   9120
         TabIndex        =   4
         Top             =   600
      ...
      Begin KewlButtonz.KewlButtons bclientes 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_debito.frx":3A3C
         PICN            =   "frmnota_debito.frx":3A58
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons bvendedor 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_debito.frx":3FF2
         PICN            =   "frmnota_debito.frx":400E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmnota_debito.frx":45A8
         Height          =   375
         Left            =   4680
         TabIndex        =   35
         Top             =   360
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmnota_debito.frx":45C2
         Height          =   360
         Left            =   11160
         TabIndex        =   6
         Top             =   1080
      ...
      Begin KewlButtonz.KewlButtons agregaproducto 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_debito.frx":45E0
         PICN            =   "frmnota_debito.frx":45FC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons KewlButtons1 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_debito.frx":4B96
         PICN            =   "frmnota_debito.frx":4BB2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmnota_debito.frx":5184
         Height          =   495
         Left            =   2880
         TabIndex        =   36
         Top             =   600
   ...
   End
End
Attribute VB_Name = "frmnota_debito"
...
Private Sub bclientes_Click()
  ...
  End If
    ...
    If datcliente.Recordset.RecordCount = 1 Then
        ...
        Else
            tpago = "CTA.CTE."
            DataCombo3.Text = "06- 30 DIAS FECHA DE FACTURA Y/O REMITO"
        End If
        ...
        End If
        xcontrolrem = datiibb.Recordset.Fields("COEFICIENTE")
...
On Error Resume Next
    ...
    For X = 1 To xlineasmax
            ...
            End If
            If Val(grilla.TextMatrix(X, 11)) = 1 Then
                xsubtotalexento = xsubtotalexento + xsubtotal
            End If
            
            xtotalgral = xtotalgral + xgrilla
            xsubtotalgral = xsubtotalgral + xsubtotal
            xivatot = xiva10 + xiva21
    Next X
    
'--- Calculo de Tem
    xcalculotem = 0
    If UCase(xcalculatempyp) = "S" And xciudadtem = xciudadcliente And DataGrid2.Columns(16).Text <> "CF" And DataGrid2.Columns(16).Text <> "EX" And xivatot <> 0 And xcontroltem <> 0 Then
        xcalculotem = ((xsubtotalgral - xsubtotalexento) * xalicuptatempip / 100) * ((100 - xexentotem) / 100)
    End If
'--- Fin Calculo Tem

'--- Calculo de IIBB
    xcalculoIIBB = 0
    If UCase(xcalculaiibb) = "S" And DataGrid2.Columns(16).Text <> "CF" And DataGrid2.Columns(16).Text <> "EX" And xivatot <> 0 Then
        xcalculoIIBB = ((xsubtotalgral - xsubtotalexento) * xalicuotaiibb / 100) * ((100 - xexentoiibb) / 100)
    End If
'--- Fin Calculo IIBB
...
'On Error Resume Next
    ...
    If datencabezado.Recordset.EOF = False Then
     ...
     If tipofac = "NN" Then frmnota_debito.Caption = "PRESUPUESTO DE VENTA"
...
'*** Fin carga Vendedor
       ...
       If remdev = 0 Then
        datitems.RecordSource = "SELECT  NV.id, NV.claveprimaria, NV.codigoproducto, NV.cantidadproducto, NV.unidaddemedidaid, NV.preciou, NV.listaid, NV.bonificacionitem, NV.importedebonificacion, " & _
                                ...
                                "Where (NV.cantidadproducto > ISNULL(IFAC.cantidadproducto, 0)) and nv.claveprimaria = " & xidpre & " " & _
                                "ORDER BY NV.id"
       ...
       End If
        ...
        For X = xinicio To datitems.Recordset.RecordCount + xinicio - 1
            ...
            If IsNull(datitems.Recordset.Fields("cant_remitida")) = False Then
                grilla.TextMatrix(X, 3) = datitems.Recordset.Fields("cant_remitida") - datitems.Recordset.Fields("cant_facturada")
            Else
                grilla.TextMatrix(X, 3) = -datitems.Recordset.Fields("cant_facturada")
            End If
...
'If fe.iniciar(modoFiscal_Test, "20102028245", "mmosse_test.pfx", "") Then
   ...
   If fe.f1ObtenerTicketAcceso() Then
        ...
        If Text1(2).Text = "A" Then
            TipoComp = 2 ' ND A(Ver excel referencias codigos AFIP)
        Else
            TipoComp = 7 ' ND B(Ver excel referencias codigos AFIP)
        End If
      ...
      Else
        fe.F1DetalleImpNeto = 0
        fe.F1DetalleImpOpEx = xneto
      End If
...
frmnota_debito.Top = yventana - frmnota_debito.Height / 2
frmnota_debito.Left = xventana - frmnota_debito.Width / 2
...
mensa = MsgBox("Desea Grabar esta Nota de Debito ?", vbYesNo, "!! Atención !!")
 If mensa = vbYes Then
...
'On Error GoTo errorgrabar
    ...
    datencabezado.Recordset.Fields("numeradorinterno") = "NOTA DE DÉDITO DE VENTA"
    ...
    If datencabezado.Recordset.Fields("tipodefacturacionid") = "MA" Then
      If Text1(2).Text = "A" Then
            xnumerador = "Nota de Debito A (Vtas) " + datparametros.Recordset.Fields("sucursal")
      Else
            xnumerador = "Nota de Debito B (Vtas) " + datparametros.Recordset.Fields("sucursal")
      End If
    End If
...
'--- Graba Items
    ...
    For X = 1 To xlineasmax
        ...
        datitems.Recordset.Fields("preciou") = Round(grilla.TextMatrix(X, 5), 3)
...
'******* Graba ud_ezi_cola  y/o Cola importar
    ...
    If datencabezado.Recordset.Fields("tipodefacturacionid") = "CF" Then
        ...
        datcola.Recordset.Fields("accion") = "D" + datencabezado.Recordset.Fields("tipodefactura")
    ...
    Else
        ...
        datcolaimportar.Recordset.Fields("tipodedocumentoid") = datparametros.Recordset.Fields("idnotadebito")
...
With CrystalReporte
    ...
    End If
    If Text1(2).Text = "A" Then
        .ReportFileName = App.Path & "\NotaDebitoA.rpt"
    Else
        .ReportFileName = App.Path & "\NotaDebitoB.rpt"
    End If
    .WindowTitle = "Debito Vta Orig"
