...
Begin VB.Form frmdepclientes 
   ...
   Begin MSDataListLib.DataList DataList2 
      Bindings        =   "frmdepclientes.frx":0000
      Height          =   1425
      Left            =   2400
      TabIndex        =   4
      Top             =   3480
   ...
   Begin MSDataListLib.DataList DataList1 
      Bindings        =   "frmdepclientes.frx":0016
      Height          =   1425
      Left            =   3240
      TabIndex        =   0
      Top             =   720
   ...
   Begin VB.Frame Frame1 
      Caption         =   "Depuración Libro Ventas:"
      Height          =   855
      Left            =   120
      TabIndex        =   7
      Top             =   120
   ...
   Begin VB.Frame Frame2 
      Caption         =   "Depuracion Recibos de Cobranza:"
      Height          =   1455
      Left            =   120
      TabIndex        =   8
      Top             =   2760
...
bar1.Min = 0
If grilla1.Rows = 1 Then GoTo sale
For x = 1 To grilla1.Rows - 1
    grilla1.Col = 0
    grilla1.Row = x
    viejovalor = grilla1.Text
    datlibrocompras.RecordSource = "select libroventas.* from libroventas WHERE libroventas.empresa = " & login.empresaact & " and cliente = '" & grilla1.Text & "'"
    ...
    Do While Not datlibrocompras.Recordset.EOF
            ...
            datlibrocompras.Recordset.Fields("cliente") = grilla1.Text
...
For x = 1 To grilla2.Rows - 1
    ...
    datordenes.RecordSource = "select recibocobroabonan.* from recibocobroabonan WHERE recibocobroabonan.empresa = " & login.empresaact & " and nomcliente = '" & grilla2.Text & "'"
    datordenes.Refresh
    If datordenes.Recordset.EOF = True Then GoTo salir
    ...
    Do While Not datordenes.Recordset.EOF
            ...
            datordenes.Recordset.Fields("nomcliente") = grilla2.Text
...
End If
    ...
    datprov.RecordSource = "select clientes.* from clientes where empresa = " & empresareal & " ORDER BY razonsocial"
    datprov.Refresh
    
    datproveedor.RecordSource = "select CLIENTESPERDIDOS.* from CLIENTESPERDIDOS where empresa = " & login.empresaact & ""
    datproveedor.Refresh
    
    datproveedores1.RecordSource = "select CLIENTESPERDIDOS1.* from CLIENTESPERDIDOS1 where empresa = " & login.empresaact & ""
...
Do While Not datproveedor.Recordset.EOF
    grilla1.Col = 0
    grilla1.Row = i
    grilla1.Text = datproveedor.Recordset.Fields("cliente")
    grilla1.Col = 1
...
Do While Not datproveedores1.Recordset.EOF
    grilla2.Col = 0
    grilla2.Row = i
    grilla2.Text = datproveedores1.Recordset.Fields("nomcliente")
    grilla2.Col = 1
