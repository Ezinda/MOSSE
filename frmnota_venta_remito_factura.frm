...
Begin VB.Form frmnota_venta_remito_factura 
   ...
   ClientTop       =   330
   ClientWidth     =   15225
   Icon            =   "frmnota_venta_remito_factura.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin KewlButtonz.KewlButtons buscar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito_factura.frx":0442
         PICN            =   "frmnota_venta_remito_factura.frx":045E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito_factura.frx":09F0
         PICN            =   "frmnota_venta_remito_factura.frx":0A0C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons grabar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito_factura.frx":1556
         PICN            =   "frmnota_venta_remito_factura.frx":1572
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito_factura.frx":2FF4
         PICN            =   "frmnota_venta_remito_factura.frx":3010
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmnota_venta_remito_factura.frx":3A22
         Height          =   255
         Left            =   3960
         TabIndex        =   35
         Top             =   0
      ...
      Begin MSDataListLib.DataCombo DataCombo3 
         Bindings        =   "frmnota_venta_remito_factura.frx":3A3C
         Height          =   360
         Left            =   9120
         TabIndex        =   4
         Top             =   600
      ...
      Begin KewlButtonz.KewlButtons bclientes 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito_factura.frx":3A56
         PICN            =   "frmnota_venta_remito_factura.frx":3A72
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons bvendedor 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito_factura.frx":400C
         PICN            =   "frmnota_venta_remito_factura.frx":4028
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmnota_venta_remito_factura.frx":45C2
         Height          =   360
         Left            =   11160
         TabIndex        =   6
         Top             =   1080
      ...
      Begin KewlButtonz.KewlButtons agregaproducto 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito_factura.frx":45E0
         PICN            =   "frmnota_venta_remito_factura.frx":45FC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons KewlButtons1 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito_factura.frx":4B96
         PICN            =   "frmnota_venta_remito_factura.frx":4BB2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons blanco 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito_factura.frx":514C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons negro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito_factura.frx":5168
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmnota_venta_remito_factura.frx":5184
         Height          =   495
         Left            =   2880
         TabIndex        =   36
         Top             =   600
   ...
   End
End
Attribute VB_Name = "frmnota_venta_remito_factura"
...
Private Sub Cancelar_Click()
    ...
    Unload Me
    frmcentrodefacturacion.Command4.SetFocus
...
On Error Resume Next
    ...
    If datencabezado.Recordset.EOF = False Then
     ...
     xtipopago = datencabezado.Recordset.Fields("tipodepagoid")
     Text20.Text = datencabezado.Recordset.Fields("recetaid")
     If IsNull(datencabezado.Recordset.Fields("retira")) = False Then
        Text1(7).Text = datencabezado.Recordset.Fields("retira")
   ...
   '     If DataGrid2.Columns(17).Text <> "" Then
         If xtipopago <> "" Then
         '   DataCombo3.BoundText = DataGrid2.Columns(17).Text
            DataCombo3.BoundText = xtipopago
            testpos = InStr(1, DataCombo3.Text, "- ", 1)
...
'*** Fin carga Vendedor
       ...
       If remdev = 0 Then
        datitems.RecordSource = "SELECT     id, claveprimaria, codigoproducto, cantidadproducto, unidaddemedidaid, preciou, listaid, bonificacionitem, importedebonificacion, subtotal, tipodeentregaitemid, " & _
                                "nombre_producto, iva, observacion, entregar, idproducto, idclaveprimariaremito, iditemremito, cantidadproducto AS Cant_Orig, MAX(0) AS Cant_Remitida, MAX(0)  " & _
                                "AS Cant_Facturada, NULL AS Um, item FROM         ud_ezi_puntodeventa_detalle_notav AS NV WITH (readpast) " & _
                                "GROUP BY id, claveprimaria, codigoproducto, cantidadproducto, unidaddemedidaid, preciou, listaid, bonificacionitem, importedebonificacion, subtotal, tipodeentregaitemid, " & _
                                "nombre_producto , iva, observacion, entregar, idproducto, idclaveprimariaremito, iditemremito, item " & _
                                "HAVING      (NV.claveprimaria = " & xidpre & ") " & _
                                "ORDER BY NV.id "
       ...
       Else
        datitems.RecordSource = "SELECT  NV.id, NV.claveprimaria, NV.codigoproducto, NV.cantidadproducto, NV.unidaddemedidaid, NV.preciou, NV.listaid, NV.bonificacionitem, NV.importedebonificacion, " & _
                                ...
                                "NV.cantidadproducto AS Cant_Orig, R.cantidadremitida AS Cant_Remitida, ISNULL(IFAC.cantidadproducto, 0) AS Cant_Facturada, R.unidaddemedida AS Um, item " & _
       ...
       End If
        ...
        For X = xinicio To datitems.Recordset.RecordCount + xinicio - 1
            ...
            grilla.TextMatrix(X, 3) = datitems.Recordset.Fields("cant_orig")
...
'            grilla.TextMatrix(X, 16) = xiditemremitovta ' id item remito
            ...
            grilla.TextMatrix(X, 18) = datitems.Recordset.Fields("listaid")
            grilla.Col = 3
            grilla.Row = X
            Call calcula_Click
...
frmnota_venta_remito_factura.Top = yventana - frmnota_venta_remito_factura.Height / 2
frmnota_venta_remito_factura.Left = xventana - frmnota_venta_remito_factura.Width / 2

If Left(login.nombrebd, 14) = "MMOSSE" Then
  If tipodeventa = 0 Then
    frmnota_venta_remito_factura.Caption = "VENTA"
    Aplicar_skin Me
  Else
    frmnota_venta_remito_factura.Caption = "PRESUPUESTO DE VENTA"
'    Aplicar_skin2 Me
    Aplicar_skin Me
  End If
End If
...
On Error Resume Next
 ...
 If xlimitecredito < 0 Then
    mensa = MsgBox("El Limite de Credito será superado con esta Factura, no permitirá FACTURAR EN CAJA", vbCritical, "LIMITE DE CRÉDITO SUPERADO")
    Call Cancelar_Click
    Exit Sub
 End If
...
'            End If
    ...
    datencabezado.Recordset.Fields("fechadelcomprobante") = DateValue(frmnota_venta_remito_factura.Text3.Text) + TimeValue(Str(Time))
    datencabezado.Recordset.Fields("sucursal") = frmnota_venta_remito_factura.datparametros.Recordset.Fields("sucursal")
    datencabezado.Recordset.Fields("clienteid") = frmnota_venta_remito_factura.DataGrid2.Columns(0).Text
    datencabezado.Recordset.Fields("cliente") = frmnota_venta_remito_factura.DataGrid2.Columns(2).Text
    If Text1(6).Text <> "" Then
        datencabezado.Recordset.Fields("cliente") = Text1(6).Text
        datencabezado.Recordset.Fields("recetaid") = Text1(3).Text
    End If
    datencabezado.Recordset.Fields("vendedorid") = frmnota_venta_remito_factura.DataGrid1.Columns(0).Text
    datencabezado.Recordset.Fields("vendedor") = frmnota_venta_remito_factura.DataGrid1.Columns(2).Text
    datencabezado.Recordset.Fields("detalle") = frmnota_venta_remito_factura.Text1(5).Text
    datencabezado.Recordset.Fields("nota") = frmnota_venta_remito_factura.Text15.Text
    datencabezado.Recordset.Fields("cotizacion") = 1
    datencabezado.Recordset.Fields("listadeprecioid") = frmnota_venta_remito_factura.DataCombo1.BoundText
    If frmnota_venta_remito_factura.DataCombo3.BoundText <> "" Then
        datencabezado.Recordset.Fields("tipodepagoid") = frmnota_venta_remito_factura.DataCombo3.BoundText
    Else
    ...
    If Text20.Text <> "" Then
        datencabezado.Recordset.Fields("recetaid") = Text20.Text
    End If
    
    If frmnota_venta_remito_factura.tipofac <> "NN" Then
        datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_remito_factura.datparametros.Recordset.Fields("facdefecto")
    Else
        datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_remito_factura.tipofac
    End If
    
    If Left(login.nombrebd, 14) = "MMOSSE" And frmnota_venta_remito_factura.tipofac <> "NN" Then
        If frmnota_venta_remito_factura.tpago = "CONTADO" Then
            datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_remito_factura.datparametros.Recordset.Fields("facdefecto")
        Else
            datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_remito_factura.datparametros.Recordset.Fields("facdefectocc")
        End If
    End If
    
    datencabezado.Recordset.Fields("fechadeentrega") = DateValue(frmnota_venta_remito_factura.Text3.Text) + TimeValue(Str(Time))
    If frmnota_venta_remito_factura.Text13.Text = "" Then frmnota_venta_remito_factura.Text13.Text = 0
    datencabezado.Recordset.Fields("recargo") = Round(frmnota_venta_remito_factura.Text13.Text, 2)
    datencabezado.Recordset.Fields("tiporecargo") = "$"
    If frmnota_venta_remito_factura.Text11.Text = "" Then frmnota_venta_remito_factura.Text11.Text = 0
    datencabezado.Recordset.Fields("bonificacion") = Round(frmnota_venta_remito_factura.Text11.Text, 2)
    datencabezado.Recordset.Fields("tipobonificacion") = "$"
    datencabezado.Recordset.Fields("importeglobal") = Round(frmnota_venta_remito_factura.Text4.Text, 2)
    datencabezado.Recordset.Fields("domicilioid") = frmnota_venta_remito_factura.Text1(3).Text
If login.nomsucursal <> "EMPORIOZIP" And login.nomsucursal <> "TUCUMANZIP" Then
    If frmnota_venta_remito_factura.DataGrid2.Columns("domicilio_id").Text <> "" Then
        datencabezado.Recordset.Fields("domicilio_id") = frmnota_venta_remito_factura.DataGrid2.Columns("domicilio_id").Text
    End If
End If
    datencabezado.Recordset.Fields("domiciliodeentregaid") = frmnota_venta_remito_factura.DataGrid2.Columns("domicilio_id").Text
    datencabezado.Recordset.Fields("subtotalsiniva") = Round(frmnota_venta_remito_factura.Text5.Text, 2)
    datencabezado.Recordset.Fields("totaliva") = Round(frmnota_venta_remito_factura.Text6.Text, 2) + Round(frmnota_venta_remito_factura.Text7.Text, 2)
    ...
    datencabezado.Recordset.Fields("target") = frmnota_venta_remito_factura.datparametros.Recordset.Fields("sucursal")
    ...
    datencabezado.Recordset.Fields("tipodefactura") = frmnota_venta_remito_factura.Text1(2).Text
    datencabezado.Recordset.Fields("percepiibb") = Round(frmnota_venta_remito_factura.Text9.Text, 2)
    datencabezado.Recordset.Fields("perceptem") = Round(frmnota_venta_remito_factura.Text8.Text, 2)
    datencabezado.Recordset.Fields("totaltr") = Round(frmnota_venta_remito_factura.Text4.Text, 2)
    datencabezado.Recordset.Fields("presupuestobase") = presupuestobase
    datencabezado.Recordset.Fields("trazabilidad_id") = presupuestobase
...
'--- Graba Items
    ...
    For X = 1 To xlineasmax
        If frmnota_venta_remito_factura.grilla.TextMatrix(1, 0) = "" Then
          mensa = MsgBox("No puede Grabar esta Venta sin Items", vbCritical, "Error")
          Exit Sub
        End If
        If frmnota_venta_remito_factura.grilla.TextMatrix(X, 0) = "" Then Exit For
        
        datitems.Recordset.AddNew
        datitems.Recordset.Fields("claveprimaria") = xid
        datitems.Recordset.Fields("idproducto") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 0)
        datitems.Recordset.Fields("codigoproducto") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 1)
        datitems.Recordset.Fields("nombre_producto") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 2)
        datitems.Recordset.Fields("cantidadproducto") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 3)
        datitems.Recordset.Fields("unidaddemedidaid") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 4)
        datitems.Recordset.Fields("preciou") = Round(frmnota_venta_remito_factura.grilla.TextMatrix(X, 6), 4)
        datitems.Recordset.Fields("preciousiva") = Round(frmnota_venta_remito_factura.grilla.TextMatrix(X, 5), 4)
        If frmnota_venta_remito_factura.grilla.TextMatrix(X, 9) = "" Then frmnota_venta_remito_factura.grilla.TextMatrix(X, 9) = "0"
        datitems.Recordset.Fields("bonificacionitem") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 9)
        If frmnota_venta_remito_factura.grilla.TextMatrix(X, 8) = "" Then frmnota_venta_remito_factura.grilla.TextMatrix(X, 8) = "0"
        datitems.Recordset.Fields("importedebonificacion") = Round(frmnota_venta_remito_factura.grilla.TextMatrix(X, 8), 4)
        datitems.Recordset.Fields("subtotal") = Round(frmnota_venta_remito_factura.grilla.TextMatrix(X, 10), 4)
        datitems.Recordset.Fields("iva") = (Round(frmnota_venta_remito_factura.grilla.TextMatrix(X, 12), 4) - 1) * 100
...
'        datitems.Recordset.Fields("iditemremito") = grilla.TextMatrix(X, 16)
        ...
        datitems.Recordset.Fields("listaid") = grilla.TextMatrix(X, 18)
...
'On Error GoTo errorgrabar
    ...
    If frmnota_venta_remito_factura.tipofac <> "NN" Then
        datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_remito_factura.datparametros.Recordset.Fields("remitodefecto")
    Else
        datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_remito_factura.tipofac
    End If
...
'--- Graba Items
    ...
    For X = 1 To xlineasmax
        ...
        datitems.Recordset.Fields("claveprimaria") = xid
        datitems.Recordset.Fields("idproducto") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 0)
        datitems.Recordset.Fields("referenciaproducto") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 1)
        datitems.Recordset.Fields("nombre_producto") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 2)
        datitems.Recordset.Fields("cantidadoriginal") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 3)
        datitems.Recordset.Fields("cantidadremitida") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 3)
        datitems.Recordset.Fields("cantidadaremitir") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 3)
        
        datitems.Recordset.Fields("unidaddemedida") = frmnota_venta_remito_factura.grilla.TextMatrix(X, 4)
        
        datitems.Recordset.Fields("facturaorigen") = xid
        datitems.Recordset.Fields("lote") = grilla.TextMatrix(X, 18)
        datitems.Recordset.UpdateBatch adAffectCurrent
        frmnota_venta_remito_factura.grilla.TextMatrix(X, 15) = xid
        frmnota_venta_remito_factura.grilla.TextMatrix(X, 16) = datitems.Recordset.Fields("id")
    Next X
...
With CrystalReporte
    ...
    .ReportSource = 0
    .SQLQuery = tabla
 Rem   .Destination = crptToWindowfrmnota_venta_remito_factura.Text1(2).Text
...
On Error Resume Next
  ...
  If xcreditomaximo = 0 Then Exit Sub
