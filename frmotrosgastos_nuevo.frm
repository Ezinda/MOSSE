...
Begin VB.Form frmotrosgastos_nuevo 
   ...
   ClientWidth     =   9615
   ControlBox      =   0   'False
   Icon            =   "frmotrosgastos_nuevo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7860
   ...
   Begin MSDataListLib.DataList DataList4 
      Bindings        =   "frmotrosgastos_nuevo.frx":0442
      Height          =   2205
      Left            =   2040
      TabIndex        =   123
      Top             =   1080
   ...
   Begin VB.Frame Frame2 
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmotrosgastos_nuevo.frx":045C
         PICN            =   "frmotrosgastos_nuevo.frx":0478
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons borrar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmotrosgastos_nuevo.frx":0E8A
         PICN            =   "frmotrosgastos_nuevo.frx":0EA6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmotrosgastos_nuevo.frx":4298
         PICN            =   "frmotrosgastos_nuevo.frx":42B4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons Command3 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmotrosgastos_nuevo.frx":4DFE
         PICN            =   "frmotrosgastos_nuevo.frx":4E1A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons imprimir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmotrosgastos_nuevo.frx":582C
         PICN            =   "frmotrosgastos_nuevo.frx":5848
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin MSDataListLib.DataList DataList1 
      Bindings        =   "frmotrosgastos_nuevo.frx":8C3A
      Height          =   2205
      Left            =   1440
      TabIndex        =   32
      Top             =   1080
   ...
   Begin MSDataListLib.DataList DataList3 
      Bindings        =   "frmotrosgastos_nuevo.frx":8C57
      Height          =   1620
      Left            =   480
      TabIndex        =   44
      Top             =   4560
   ...
   Begin MSDataListLib.DataList DataList2 
      Bindings        =   "frmotrosgastos_nuevo.frx":8C74
      Height          =   1260
      Left            =   1200
      TabIndex        =   43
      Top             =   6000
   ...
   Begin VB.Frame Frame5 
      ...
      Begin KewlButtonz.KewlButtons grabalibroasiento 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmotrosgastos_nuevo.frx":8C8D
         PICN            =   "frmotrosgastos_nuevo.frx":8CA9
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "frmotrosgastos_nuevo.frx":A72B
      Height          =   495
      Left            =   7680
      TabIndex        =   35
      Top             =   5760
   ...
   Begin MSDataGridLib.DataGrid DataGrid3 
      Bindings        =   "frmotrosgastos_nuevo.frx":A745
      Height          =   735
      Left            =   7320
      TabIndex        =   38
      Top             =   6360
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ListBox List1 
         BackColor       =   &H00FFFFFF&
         Height          =   1815
         ItemData        =   "frmotrosgastos_nuevo.frx":A75E
         Left            =   1920
         List            =   "frmotrosgastos_nuevo.frx":A760
         Sorted          =   -1  'True
         TabIndex        =   4
         Top             =   1320
         Visible         =   0   'False
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmotrosgastos_nuevo.frx":A762
         Height          =   315
         Left            =   4560
         TabIndex        =   48
         Top             =   240
   ...
   Begin vbskpro.Skinner Skinner1 
      ...
      LcK2            =   $"frmotrosgastos_nuevo.frx":A77B
      AmbientB        =   ";<=>?7B:><7=<A<7CC;@"
   ...
   End
End
Attribute VB_Name = "frmotrosgastos_nuevo"
...
On Error GoTo fuera
    If KeyAscii = 13 Then
        ...
        End If
            ...
            mensa = verifica_cuit(cuit.Text, invalido)
            If invalido = 1 Then
                   cuit.SetFocus
            Else
                   tipocomp.SetFocus
  ...
  Rem      verificadorcuit = cuit.Text
  Rem      Call vercuit_Click
  Rem      If correcto = "S" Then
  Rem          tipocomp.SetFocus
  Rem      Else
  Rem          cuit.SetFocus
  Rem      End If
    End If
...
On Error GoTo fuera
     If KeyAscii = 13 Then
        tipoiva.Text = DataList4.BoundText
...
Private Sub denominacion_KeyUp(KeyCode As Integer, Shift As Integer)
...
frmotrosgastos_nuevo.Top = 0
frmotrosgastos_nuevo.Left = 0
...
Rem ****************** grabar asiento
    ...
    If modificar = 1 Then
        datmaestro.RecordSource = "select [Maestro Asientos].* from [Maestro Asientos] where empresa = " & login.empresaact & " and perinicial = '" & login.iper & "' and nroasiento = " & datprimaryrs.Recordset.Fields("asiento") & " "
        datmaestro.Refresh
        If datmaestro.Recordset.EOF = False Then datmaestro.Recordset.Delete adAffectCurrent
    End If
...
For x = 0 To 30 Step 2
    If Val(Text7(x).Text) <> 0 And Text3(x / 2).Text Then
         If Text3(x / 2).Visible = False Then GoTo paso1
            ...
            If grilla.Text <> "" Then
                For Y = 0 To 3
                    ...
                    If x <> 30 Then
                        If Text3(15).Text < 0 Then
                            datasiento.Recordset.Fields(3) = 0
                            datasiento.Recordset.Fields(4) = Val(grilla.Text)
                        Else
                            datasiento.Recordset.Fields(4) = 0
                            datasiento.Recordset.Fields(3) = Val(grilla.Text)
                        End If
                    Else
                        If Text3(15).Text < 0 Then
                            datasiento.Recordset.Fields(3) = Val(grilla.Text)
            ...
            If x <> 30 Then
              If Val(Text3(15).Text) < 0 Then
                datasiento.Recordset.Fields(4) = Text3(x / 2).Text * -1
                datasiento.Recordset.Fields(3) = 0
              Else
...
paso1:
            grilla.Row = 15
            grilla.Col = 0
            If Val(grilla.Text) <> 0 Then GoTo paso2
            datasiento.Recordset.AddNew
            datasiento.Recordset.Fields(5) = Val(datmaestro.Recordset.Fields(2))
            datasiento.Recordset.Fields(1) = datmaestro.Recordset.Fields(0).Value
            datasiento.Recordset.Fields(7) = login.empresaact
...
Private Sub imprimir_Click()
        ...
        MsgBox "Debe Ingresar a Cta.Cte para buscar informacion", vbInformation, "Atención"
        Exit Sub

            
End Sub

Private Sub label1_GotFocus(Index As Integer)

        frmlibrocompras_nuevo.indice = Index
        frmlibrocompras_nuevo.librocontado = 1
        grilla.Row = Index
        x = 0
            grilla.Col = x
...
Dim año As Integer
    ...
    If KeyAscii = 13 Then
        ...
        If Right(Maskfecha.Text, 2) = "__" Then
