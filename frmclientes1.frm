...
Begin VB.Form frmclientes1 
   ...
   Begin MSAdodcLib.Adodc datPrimaryRS 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "select codcliente,empresa,razonsocial,tipoiva,cuit,domicilio,localidad,codpostal,telefono,email,contacto from clientes"
      Caption         =   " "
   ...
   End
End
Attribute VB_Name = "frmclientes1"
