...
Begin VB.Form frmcobranzacdo_facc 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ingreso de Valores desde Factura de Alquiler"
   ClientHeight    =   6150
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11640
   Icon            =   "frmcobranzacdo_facc.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame cheques 
      ...
      Begin MSDataListLib.DataCombo DataCombo5 
         Bindings        =   "frmcobranzacdo_facc.frx":0442
         Height          =   360
         Left            =   240
         TabIndex        =   34
         Top             =   1680
   ...
   Begin VB.Frame tarjeta 
      ...
      Begin MSDataListLib.DataCombo DataCombo2 
         Bindings        =   "frmcobranzacdo_facc.frx":0459
         Height          =   360
         Left            =   240
         TabIndex        =   16
         Top             =   720
      ...
      Begin MSDataListLib.DataCombo DataCombo3 
         Bindings        =   "frmcobranzacdo_facc.frx":0473
         Height          =   360
         Left            =   240
         TabIndex        =   19
         Top             =   1560
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmcobranzacdo_facc.frx":048A
         Height          =   360
         Left            =   2400
         TabIndex        =   2
         Top             =   240
   ...
   Begin VB.Frame Frame3 
      ...
      Begin KewlButtonz.KewlButtons grabar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmcobranzacdo_facc.frx":04A3
         PICN            =   "frmcobranzacdo_facc.frx":04BF
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmcobranzacdo_facc.frx":1F41
         PICN            =   "frmcobranzacdo_facc.frx":1F5D
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmcobranzacdo_facc"
...
frmcobranzacdo_facc.DataCombo1.SetFocus
...
frmcobranzacdo_facc.Top = yventana - frmcobranzacdo_facc.Height / 2
frmcobranzacdo_facc.Left = xventana - frmcobranzacdo_facc.Width / 2
...
'On Error GoTo errorgrabar
 ...
 If mensa = vbYes Then
    ...
    datencabezado.Recordset.Fields("fechadelcomprobante") = DateValue(frmfacctacte_alquiler.Text3.Text) + TimeValue(Str(Time))
    datencabezado.Recordset.Fields("sucursal") = frmfacctacte_alquiler.datparametros.Recordset.Fields("sucursal")
    datencabezado.Recordset.Fields("clienteid") = frmfacctacte_alquiler.DataGrid2.Columns(0).Text
    datencabezado.Recordset.Fields("cliente") = frmfacctacte_alquiler.DataGrid2.Columns(2).Text
    datencabezado.Recordset.Fields("vendedorid") = frmfacctacte_alquiler.DataGrid1.Columns(0).Text
    datencabezado.Recordset.Fields("vendedor") = frmfacctacte_alquiler.DataGrid1.Columns(2).Text
    datencabezado.Recordset.Fields("detalle") = frmfacctacte_alquiler.Text1(5).Text
    datencabezado.Recordset.Fields("nota") = frmfacctacte_alquiler.Text15.Text
    datencabezado.Recordset.Fields("cotizacion") = 1
    datencabezado.Recordset.Fields("listadeprecioid") = frmfacctacte_alquiler.DataCombo1.BoundText
    datencabezado.Recordset.Fields("tipodepagoid") = frmfacctacte_alquiler.DataCombo3.BoundText
    datencabezado.Recordset.Fields("alquiler") = "N"
    
    If frmfacctacte_alquiler.tipofac <> "NN" Then
        datencabezado.Recordset.Fields("tipodefacturacionid") = frmfacctacte_alquiler.datparametros.Recordset.Fields("facdefecto")
    Else
        datencabezado.Recordset.Fields("tipodefacturacionid") = frmfacctacte_alquiler.tipofac
    End If
    
    If Left(login.nombrebd, 14) = "MMOSSE" And frmfacctacte_alquiler.tipofac <> "NN" Then
        testpos = InStr(1, frmfacctacte_alquiler.DataCombo3.Text, "- ", 1)
        tpago = Right(frmfacctacte_alquiler.DataCombo3.Text, Len(frmfacctacte_alquiler.DataCombo3.Text) - testpos - 1)
    ...
    datencabezado.Recordset.Fields("fechadeentrega") = DateValue(frmfacctacte_alquiler.Text3.Text) + TimeValue(Str(Time))
    datencabezado.Recordset.Fields("recargo") = 0
    datencabezado.Recordset.Fields("tiporecargo") = "$"
    datencabezado.Recordset.Fields("bonificacion") = 0
    datencabezado.Recordset.Fields("tipobonificacion") = "$"
    datencabezado.Recordset.Fields("importeglobal") = Round(frmfacctacte_alquiler.Text4.Text, 2)
    datencabezado.Recordset.Fields("domicilioid") = frmfacctacte_alquiler.Text1(3).Text
    datencabezado.Recordset.Fields("domicilio_id") = frmfacctacte_alquiler.DataGrid2.Columns("domicilio_id").Text
    datencabezado.Recordset.Fields("domiciliodeentregaid") = frmfacctacte_alquiler.DataGrid2.Columns("domicilio_id").Text
    datencabezado.Recordset.Fields("subtotalsiniva") = Round(frmfacctacte_alquiler.Text5.Text, 2)
    datencabezado.Recordset.Fields("totaliva") = Round(frmfacctacte_alquiler.Text6.Text, 2) + Round(frmfacctacte_alquiler.Text7.Text, 2)
    ...
    datencabezado.Recordset.Fields("target") = frmfacctacte_alquiler.datparametros.Recordset.Fields("sucursal")
    If frmfacctacte_alquiler.DataGrid2.Columns(16).Text = "RI" Then xresponsabilidad = "Resp. Inscripto"
    If frmfacctacte_alquiler.DataGrid2.Columns(16).Text = "EX" Then xresponsabilidad = "Exento"
    If frmfacctacte_alquiler.DataGrid2.Columns(16).Text = "MT" Then xresponsabilidad = "Monotributista"
    If frmfacctacte_alquiler.DataGrid2.Columns(16).Text = "CF" Then xresponsabilidad = "Consumidor Final"
    datencabezado.Recordset.Fields("responsabilidad") = xresponsabilidad
    datencabezado.Recordset.Fields("transferido") = "False"
    
    datencabezado.Recordset.Fields("tipodefactura") = frmfacctacte_alquiler.Text1(2).Text
    datencabezado.Recordset.Fields("percepiibb") = Round(frmfacctacte_alquiler.Text9.Text, 2)
    datencabezado.Recordset.Fields("perceptem") = Round(frmfacctacte_alquiler.Text8.Text, 2)
    datencabezado.Recordset.Fields("totaltr") = Round(frmfacctacte_alquiler.Text4.Text, 2)
    datencabezado.Recordset.Fields("presupuestobase") = frmfacctacte_alquiler.presupuestobase
    nromanual = frmfacctacte_alquiler.Text1(9).Text
    puntomanual = frmfacctacte_alquiler.datparametros.Recordset.Fields("puntovtamanual")
    
    datencabezado.Recordset.UpdateBatch adAffectCurrent
    xid = datencabezado.Recordset.Fields("id")
    
    Debug.Print frmfacctacte_alquiler.Text1(2).Text
    '** Establene numero de Facturas Manuales, y no Fiscales
    If datencabezado.Recordset.Fields("tipodefacturacionid") = "MA" Or frmfacctacte_alquiler.Text1(2).Text = "A" Then  ' Solo para Colon, para otra empresa verificar
      If frmfacctacte_alquiler.Text1(2).Text = "A" Then
            xnumerador = "Factura A (Vtas) " + frmfacctacte_alquiler.datparametros.Recordset.Fields("sucursal")
      Else
            xnumerador = "Factura B (Vtas) " + frmfacctacte_alquiler.datparametros.Recordset.Fields("sucursal")
      End If
    End If
    If datencabezado.Recordset.Fields("tipodefacturacionid") = "NN" Then
            xnumerador = "Factura de Venta Val " + frmfacctacte_alquiler.datparametros.Recordset.Fields("sucursal")
    End If
    ...
    If datencabezado.Recordset.Fields("tipodefacturacionid") = "CF" And frmfacctacte_alquiler.Text1(2).Text = "B" Then
...
'--- Graba Items
    ...
    For X = 1 To frmfacctacte_alquiler.xlineasmax
        If frmfacctacte_alquiler.grilla.TextMatrix(1, 0) = "" Then
          mensa = MsgBox("No puede Grabar esta Venta sin Items", vbCritical, "Error")
          Exit Sub
        End If
        If frmfacctacte_alquiler.grilla.TextMatrix(X, 0) = "" Then Exit For
        
        datitems.Recordset.AddNew
        datitems.Recordset.Fields("claveprimaria") = xid
        datitems.Recordset.Fields("idproducto") = frmfacctacte_alquiler.grilla.TextMatrix(X, 0)
        datitems.Recordset.Fields("codigoproducto") = frmfacctacte_alquiler.grilla.TextMatrix(X, 1)
        datitems.Recordset.Fields("nombre_producto") = frmfacctacte_alquiler.grilla.TextMatrix(X, 2)
        datitems.Recordset.Fields("cantidadproducto") = frmfacctacte_alquiler.grilla.TextMatrix(X, 3)
        datitems.Recordset.Fields("unidaddemedidaid") = frmfacctacte_alquiler.grilla.TextMatrix(X, 4)
        datitems.Recordset.Fields("preciou") = Round(frmfacctacte_alquiler.grilla.TextMatrix(X, 6), 3)
        datitems.Recordset.Fields("preciousiva") = Round(frmfacctacte_alquiler.grilla.TextMatrix(X, 5), 3)
        datitems.Recordset.Fields("bonificacionitem") = frmfacctacte_alquiler.grilla.TextMatrix(X, 9)
        datitems.Recordset.Fields("importedebonificacion") = 0
        datitems.Recordset.Fields("subtotal") = Round(frmfacctacte_alquiler.grilla.TextMatrix(X, 10), 3)
        datitems.Recordset.Fields("iva") = (Round(frmfacctacte_alquiler.grilla.TextMatrix(X, 12), 4) - 1) * 100
    ...
    datcontrol.RecordSource = "Select id, generada from ud_ezi_puntodeventa_encabezado with (readpast) where id = '" & frmfacctacte_alquiler.presupuestobase & "'"
    datcontrol.Refresh
...
'******* Graba Pago
    ...
    For X = 1 To 29
        ...
        datpago.Recordset.Fields("destinoid") = frmfacctacte_alquiler.datparametros.Recordset.Fields("cajadefecto")
...
'******* Graba ud_ezi_cola
    ...
    If datencabezado.Recordset.Fields("tipodefacturacionid") = "CF" And frmfacctacte_alquiler.Text1(2).Text = "B" Then
        ...
        datcola.Recordset.Fields("target") = frmfacctacte_alquiler.datparametros.Recordset.Fields("target")
        datcola.Recordset.Fields("claveprimaria") = xid
    
        datcola.Recordset.UpdateBatch adAffectCurrent
        
            frmfacctacte_alquiler.cancelar.SetFocus
    ...
    Else
        ...
        datcola.Recordset.Fields("tipodedocumentoid") = frmfacctacte_alquiler.datparametros.Recordset.Fields("idfaccdo")
        datcola.Recordset.Fields("unidadoperativaid") = frmfacctacte_alquiler.datparametros.Recordset.Fields("target")
        datcola.Recordset.Fields("fecha_hora") = DateValue(frmfacctacte_alquiler.Text3.Text) + TimeValue(Str(Time))
...
If frmfacctacte_alquiler.datparametros.Recordset.Fields("imprimemanual") = "N" Or frmfacctacte_alquiler.Text1(9).Text <> "" Then
    frmfacctacte_alquiler.cancelar.SetFocus
    SendKeys "{ENTER}", False
    Unload Me
    Exit Sub
