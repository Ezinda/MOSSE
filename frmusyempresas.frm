...
Begin VB.Form frmusyempresas 
   ...
   Begin MSAdodcLib.Adodc datPrimaryRS 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "select nomusuario,altas,bajas,modificaciones,empresa from usyempresas Order by empresa"
      Caption         =   " "
   ...
   Begin MSDataGridLib.DataGrid grdDataGrid 
      Align           =   1  'Align Top
      Bindings        =   "frmusyempresas.frx":0000
      Height          =   3495
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmusyempresas"
