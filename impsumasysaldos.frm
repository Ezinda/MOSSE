...
Begin VB.Form impsumasysaldos 
   ...
   Begin KewlButtonz.KewlButtons listar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "impsumasysaldos.frx":0451
      PICN            =   "impsumasysaldos.frx":046D
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
On Error Resume Next
    ...
    criterio.Recordset.Fields(2) = cargahasta.Value
    criterio.Recordset.Fields("cuenta1") = Text2(0).Text
    criterio.Recordset.Fields("cuenta2") = Text2(1).Text
