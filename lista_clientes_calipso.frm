...
Begin VB.Form lista_clientes_calipso 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "lista_clientes_calipso.frx":0000
      Height          =   8055
      Left            =   120
      TabIndex        =   0
      Top             =   600
   ...
   End
End
Attribute VB_Name = "lista_clientes_calipso"
...
datcliente.ConnectionString = conexiontotal
     ...
     xquery = "SELECT  ALIAS_0.ID AS ID,  ALIAS_0.CODIGO, ALIAS_3.NOMBRE AS RAZONSOCIAL, ALIAS_3.CUIT,ALIAS_6.CALLE, ISNULL(ALIAS_6.CALLE,'') + '-'+ ISNULL(V_CIUDAD_.NOMBRE,'') + '-'+ ISNULL(V_PROVINCIA_.NOMBRE,'') AS DOMICILIO, ALIAS_0.DENOMINACION,ALIAS_5.NOMBRE AS ZONA, " & _
              ...
              "V_CIUDAD_.NOMBRE AS Ciudad, ALIAS_0.CODIGO + ' ' + ALIAS_3.CUIT + ' ' + ALIAS_3.NOMBRE AS CONCATENADO, V_EZI_POCICION_IVA_CLIENTES.CODIGO AS IVA, V_TIPOPAGO_.ID AS IDPAGO  " & _
...
Private Sub Form_Resize()
    ...
    DataGrid1.Width = lista_clientes_calipso.Width - 200
    DataGrid1.Height = lista_clientes_calipso.Height - 1000
