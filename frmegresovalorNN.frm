...
Begin VB.Form frmegresovalorNN 
   ...
   ClientTop       =   330
   ClientWidth     =   12045
   Icon            =   "frmegresovalorNN.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmegresovalorNN.frx":0442
         Height          =   1695
         Left            =   120
         TabIndex        =   20
         Top             =   2160
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmegresovalorNN.frx":0459
         Height          =   420
         Left            =   2400
         TabIndex        =   2
         Top             =   600
      ...
      Begin MSDataListLib.DataCombo DataCombo4 
         Bindings        =   "frmegresovalorNN.frx":0472
         Height          =   420
         Left            =   2400
         TabIndex        =   13
         Top             =   120
   ...
   Begin VB.Frame Frame3 
      ...
      Begin KewlButtonz.KewlButtons grabar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmegresovalorNN.frx":0490
         PICN            =   "frmegresovalorNN.frx":04AC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmegresovalorNN.frx":1F2E
         PICN            =   "frmegresovalorNN.frx":1F4A
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmegresovalorNN"
...
frmegresovalorNN.Top = yventana - frmegresovalorNN.Height / 2
frmegresovalorNN.Left = xventana - frmegresovalorNN.Width / 2
fecha = Date
