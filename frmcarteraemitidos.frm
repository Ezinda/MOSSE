...
Begin VB.Form frmcarteraemitidos 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmcarteraemitidos.frx":0000
      Height          =   5295
      Left            =   120
      TabIndex        =   0
      Top             =   480
   ...
   Begin vbskpro.Skinner Skinner1 
      ...
      LcK2            =   $"frmcarteraemitidos.frx":0019
      AmbientB        =   ";<=>?7B:><7=<A<7CC;@"
   ...
   End
End
Attribute VB_Name = "frmcarteraemitidos"
...
Private Sub Command1_Click(Index As Integer)
    ...
    If Index = 3 Then
            datentrada.RecordSource = "select ordendepagoinstrumento.* from ordendepagoinstrumento where empresa = " & login.empresaact & " and fechacompro <>  '' order by fechavencim desc"
            datentrada.Refresh
    End If

    If Index = 2 Then
            datentrada.RecordSource = "select ordendepagoinstrumento.* from ordendepagoinstrumento where empresa = " & login.empresaact & " and fechacompro <>  '' order by fechacompro desc"
            datentrada.Refresh
    End If
    
    If Index = 1 Then
            datentrada.RecordSource = "select ordendepagoinstrumento.* from ordendepagoinstrumento where empresa = " & login.empresaact & " and fechacompro <>  '' order by comprobante"
            datentrada.Refresh
    End If
    
    If Index = 0 Then
            datentrada.RecordSource = "select ordendepagoinstrumento.* from ordendepagoinstrumento where empresa = " & login.empresaact & " and fechacompro <>  '' order by denominacion"
            datentrada.Refresh
    End If
