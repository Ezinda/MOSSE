...
Begin VB.Form frmnota_venta_remito 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "REMITO DE VENTA"
   ClientHeight    =   8610
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   15225
   Icon            =   "frmnota_venta_remito.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin KewlButtonz.KewlButtons buscar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito.frx":0442
         PICN            =   "frmnota_venta_remito.frx":045E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito.frx":09F0
         PICN            =   "frmnota_venta_remito.frx":0A0C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons grabar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito.frx":1556
         PICN            =   "frmnota_venta_remito.frx":1572
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito.frx":2FF4
         PICN            =   "frmnota_venta_remito.frx":3010
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmnota_venta_remito.frx":3A22
         Height          =   255
         Left            =   3960
         TabIndex        =   28
         Top             =   0
      ...
      Begin MSDataListLib.DataCombo DataCombo3 
         Bindings        =   "frmnota_venta_remito.frx":3A3C
         Height          =   360
         Left            =   9120
         TabIndex        =   4
         Top             =   600
      ...
      Begin KewlButtonz.KewlButtons bclientes 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito.frx":3A56
         PICN            =   "frmnota_venta_remito.frx":3A72
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons bvendedor 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito.frx":400C
         PICN            =   "frmnota_venta_remito.frx":4028
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmnota_venta_remito.frx":45C2
         Height          =   360
         Left            =   11160
         TabIndex        =   6
         Top             =   1080
      ...
      Begin KewlButtonz.KewlButtons agregaproducto 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito.frx":45E0
         PICN            =   "frmnota_venta_remito.frx":45FC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons KewlButtons1 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito.frx":4B96
         PICN            =   "frmnota_venta_remito.frx":4BB2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons blanco 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito.frx":514C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons negro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_remito.frx":5168
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmnota_venta_remito.frx":5184
         Height          =   495
         Left            =   2880
         TabIndex        =   29
         Top             =   600
      ...
      Begin MSAdodcLib.Adodc datcredito 
         ...
         _Version        =   393216
      End
      Begin MSAdodcLib.Adodc datlotebusca 
         Height          =   330
         Left            =   360
         Top             =   0
         Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmnota_venta_remito"
...
Public xmercaderiaentregada  As String
...
On Error Resume Next
    ...
    If datencabezado.Recordset.EOF = False Then
     ...
     xposicion = 1
     xnumeroremito = ""
     xmercaderiaentregada = datencabezado.Recordset.Fields("estadoretira")
...
'*** Fin carga Vendedor
        ...
        datitems.RecordSource = "SELECT top (20)    id, claveprimaria, referenciaproducto as codigoproducto, cantidadaremitir as cantidadproducto,unidaddemedida as unidaddemedidaid,1 as preciou, lote_id as listaid,0 as bonificacionitem, 0 as importedebonificacion, 1 as  subtotal, '' as tipodeentregaitemid, " & _
                                "nombre_producto ,0 as iva,'' as observacion,'' as entregar, idproducto, lote as idclaveprimariaremito, item as iditemremito, cantidadoriginal AS Cant_Orig, lote_id " & _
                                "FROM         ud_ezi_puntodeventa_detalle_rem AS NV WITH (readpast) where      (NV.claveprimaria = " & xidpre & ") " & _
                                "ORDER BY NV.id "
        ...
        Do While Not datitems.Recordset.EOF
            xlotepega = ""
            xlotebusca = datitems.Recordset.Fields("lote_id")
            If xlotebusca <> "" Then
                datlotebusca.RecordSource = "SELECT       V_LOTE.ID,'Lote:' + V_LOTE.CODIGO +  case when DATEDIFF(YEAR,  GETDATE(),UD_EZI_LOTE.fechavencimiento) > 20 then '' else    ' Venc.:'+ RIGHT(UD_EZI_LOTE.fechavencimiento, 2) + '/' + SUBSTRING(UD_EZI_LOTE.fechavencimiento, 5, 2) + '/' + LEFT(UD_EZI_LOTE.fechavencimiento, 4) end " & _
                                            "AS lote_venc, DATEDIFF(YEAR,  GETDATE(),UD_EZI_LOTE.fechavencimiento) " & _
                                            "FROM         V_LOTE  WITH (nolock) INNER JOIN  " & _
                                            "UD_EZI_LOTE WITH (nolock) ON BOEXTENSION_ID = UD_EZI_LOTE.ID where V_LOTE.ID = '" & xlotebusca & "' "
                datlotebusca.Refresh
                If datlotebusca.Recordset.EOF = False Then
                    xlotepega = datlotebusca.Recordset.Fields("lote_venc")
                End If
            End If
                
            grilla.TextMatrix(X, 0) = datitems.Recordset.Fields("idproducto")
            grilla.TextMatrix(X, 1) = datitems.Recordset.Fields("codigoproducto")
            grilla.TextMatrix(X, 2) = datitems.Recordset.Fields("nombre_producto") + " " + xlotepega
            ...
            grilla.TextMatrix(X, 5) = datitems.Recordset.Fields("cantidadproducto")
            grilla.TextMatrix(X, 6) = datitems.Recordset.Fields("idclaveprimariaremito")
            X = X + 1
    ...
    If datcola.Recordset.EOF = False Then
        Text1(9).Text = datcola.Recordset.Fields("numero")
    End If
...
frmnota_venta_remito.Top = yventana - frmnota_venta_remito.Height / 2
frmnota_venta_remito.Left = xventana - frmnota_venta_remito.Width / 2
...
datlotebusca.ConnectionString = login.conexiontotal
...
grilla.Col = 5
grilla.Text = "Cant.a Remitir"
grilla.ColWidth(5) = 1200

grilla.Col = 6
grilla.Text = "Lote Nro"
...
On Error GoTo errorgrabar
    ...
    datencabezado.RecordSource = "SELECT * From ud_ezi_puntodeventa_encabezado with(readpast) where id = " & xid & " "
    datencabezado.Refresh
    datitems.RecordSource = "Select * from ud_ezi_puntodeventa_detalle_rem with(readpast) where claveprimaria = " & xid & ""
    datitems.Refresh
    ...
    datencabezado.Recordset.Fields("estado") = "Remitido"
    ...
    If datencabezado.Recordset.Fields("tipodefacturacionid") = "MA" Then
       If tpago <> "CONTADO" Then
        If xmercaderiaentregada = "1" Then
            xnumerador = "Remito Manual"
        Else
            xnumerador = "Remito A (Vtas) " + datparametros.Recordset.Fields("sucursal")
        End If
    ...
    xremito = datencabezado.Recordset.Fields("id")
    
    
'--- Graba Items
    
        If datitems.Recordset.EOF = True Then
        ...
        X = 1
        Do While Not datitems.Recordset.EOF
            datitems.Recordset.Fields("cantidadremitida") = datitems.Recordset.Fields("cantidadaremitir")
