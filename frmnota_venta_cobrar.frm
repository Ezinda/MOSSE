...
Begin VB.Form frmnota_venta_cobrar 
   ...
   ClientTop       =   330
   ClientWidth     =   15150
   Icon            =   "frmnota_venta_cobrar.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin KewlButtonz.KewlButtons buscar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_cobrar.frx":0442
         PICN            =   "frmnota_venta_cobrar.frx":045E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_cobrar.frx":09F0
         PICN            =   "frmnota_venta_cobrar.frx":0A0C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons grabar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_cobrar.frx":1556
         PICN            =   "frmnota_venta_cobrar.frx":1572
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_cobrar.frx":2FF4
         PICN            =   "frmnota_venta_cobrar.frx":3010
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin KewlButtonz.KewlButtons bvendedor 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_cobrar.frx":3A22
         PICN            =   "frmnota_venta_cobrar.frx":3A3E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons bclientes 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_cobrar.frx":3FD8
         PICN            =   "frmnota_venta_cobrar.frx":3FF4
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmnota_venta_cobrar.frx":458E
         Height          =   255
         Left            =   3960
         TabIndex        =   35
         Top             =   0
      ...
      Begin MSDataListLib.DataCombo DataCombo3 
         Bindings        =   "frmnota_venta_cobrar.frx":45A8
         Height          =   360
         Left            =   9120
         TabIndex        =   4
         Top             =   600
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmnota_venta_cobrar.frx":45C2
         Height          =   360
         Left            =   11160
         TabIndex        =   6
         Top             =   1080
      ...
      Begin KewlButtonz.KewlButtons agregaproducto 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_cobrar.frx":45E0
         PICN            =   "frmnota_venta_cobrar.frx":45FC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons KewlButtons1 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_cobrar.frx":4B96
         PICN            =   "frmnota_venta_cobrar.frx":4BB2
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons blanco 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_cobrar.frx":514C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons negro 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmnota_venta_cobrar.frx":5168
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmnota_venta_cobrar.frx":5184
         Height          =   495
         Left            =   2880
         TabIndex        =   36
         Top             =   600
   ...
   End
End
Attribute VB_Name = "frmnota_venta_cobrar"
...
Public xvendedeorautoriza As String
...
On Error Resume Next
    ...
    If datencabezado.Recordset.EOF = False Then
     ...
     xdni = datencabezado.Recordset.Fields("nroorden")
    ...
    '**** Carga cliente
        ...
        xcontroltem = datiibb.Recordset.Fields("tem")
        xciudadcliente = DataGrid2.Columns("Ciudad").Text
        If DataGrid2.Columns("razonsocial").Text = "CONSUMIDOR FINAL" Then
...
'                                "NV.cantidadproducto AS Cant_Orig, R.cantidadremitida AS Cant_Remitida, SUM(ISNULL(IFAC.cantidadproducto, 0)) AS Cant_Facturada, R.unidaddemedida AS Um " & _
'                                "FROM         ud_ezi_puntodeventa_detalle_notav AS NV WITH (readpast) LEFT OUTER JOIN " & _
'                                "v_ezi_pos_remito AS R ON NV.iditemremito = R.iditem LEFT OUTER JOIN " & _
'                                "ud_ezi_puntodeventa_detalle_factm AS IFAC WITH (readpast) LEFT OUTER JOIN " & _
'                                "ud_ezi_puntodeventa_encabezado AS E WITH (readpast) ON IFAC.claveprimaria = E.id ON R.iditem = IFAC.iditemremito AND " & _
'                                "NV.cantidadproducto > ISNULL(IFAC.cantidadproducto, 0) " & _
'                                "GROUP BY NV.id, NV.claveprimaria, NV.codigoproducto, NV.cantidadproducto, NV.unidaddemedidaid, NV.preciou, NV.listaid, NV.bonificacionitem, NV.importedebonificacion, " & _
'                                "NV.subtotal, NV.tipodeentregaitemid, NV.nombre_producto, NV.iva, NV.observacion, NV.entregar, NV.idproducto, NV.idclaveprimariaremito, NV.iditemremito, " & _
'                                "R.cantidadremitida , R.unidaddemedida "
        ...
        datitems.RecordSource = "SELECT     id, claveprimaria, codigoproducto, cantidadproducto, unidaddemedidaid, preciou, listaid, bonificacionitem, importedebonificacion, subtotal, tipodeentregaitemid, " & _
                                ...
                                "AS Cant_Facturada, NULL AS Um FROM         ud_ezi_puntodeventa_detalle_notav AS NV WITH (readpast) " & _
                                ...
                                "nombre_producto , iva, observacion, entregar, idproducto, idclaveprimariaremito, iditemremito " & _
...
frmnota_venta_cobrar.Top = yventana - frmnota_venta_cobrar.Height / 2
frmnota_venta_cobrar.Left = xventana - frmnota_venta_cobrar.Width / 2

If Left(login.nombrebd, 14) = "COMERCIALCOLON" Then
  If tipodeventa = 0 Then
    frmnota_venta_cobrar_cobrar.Caption = "VENTA"
    Aplicar_skin Me
  Else
    frmnota_venta_cobrar_cobrar.Caption = "PRESUPUESTO DE VENTA"
'    Aplicar_skin2 Me
    Aplicar_skin Me
  End If
End If
...
'    If UCase(datparametros.Recordset.Fields("cobroautomatico")) = "S" And tpago = "CONTADO" Then
        frmcobranzacdo2.Show
        frmcobranzacdo2.Text1(0).Text = Format(Text4.Text, "#,###,##0.00")
'   End If
...
'On Error GoTo errorgrabar
    ...
    datencabezado.Recordset.Fields("fechadelcomprobante") = DateValue(frmnota_venta_cobrar_cobrar.Text3.Text) + TimeValue(Str(Time))
    datencabezado.Recordset.Fields("sucursal") = frmnota_venta_cobrar_cobrar.datparametros.Recordset.Fields("sucursal")
    datencabezado.Recordset.Fields("clienteid") = frmnota_venta_cobrar_cobrar.DataGrid2.Columns(0).Text
    datencabezado.Recordset.Fields("cliente") = frmnota_venta_cobrar_cobrar.DataGrid2.Columns(2).Text
    If Text1(6).Text <> "" Then
        datencabezado.Recordset.Fields("cliente") = Text1(6).Text
        datencabezado.Recordset.Fields("recetaid") = Text1(3).Text
    End If
    datencabezado.Recordset.Fields("vendedorid") = frmnota_venta_cobrar_cobrar.DataGrid1.Columns(0).Text
    datencabezado.Recordset.Fields("vendedor") = frmnota_venta_cobrar_cobrar.DataGrid1.Columns(2).Text
    datencabezado.Recordset.Fields("detalle") = frmnota_venta_cobrar_cobrar.Text1(5).Text
    datencabezado.Recordset.Fields("nota") = frmnota_venta_cobrar_cobrar.Text15.Text
    datencabezado.Recordset.Fields("cotizacion") = 1
    datencabezado.Recordset.Fields("listadeprecioid") = frmnota_venta_cobrar_cobrar.DataCombo1.BoundText
    datencabezado.Recordset.Fields("tipodepagoid") = frmnota_venta_cobrar_cobrar.DataCombo3.BoundText
    datencabezado.Recordset.Fields("alquiler") = "N"
    
    If frmnota_venta_cobrar_cobrar.tipofac <> "NN" Then
        datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_cobrar_cobrar.datparametros.Recordset.Fields("facdefecto")
    Else
        datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_cobrar_cobrar.tipofac
    End If
    
    If Left(login.nombrebd, 14) = "MMOSSE" And frmnota_venta_cobrar_cobrar.tipofac <> "NN" Then
        If frmnota_venta_cobrar_cobrar.tpago = "CONTADO" Then
            datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_cobrar_cobrar.datparametros.Recordset.Fields("facdefecto")
        Else
            datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_cobrar_cobrar.datparametros.Recordset.Fields("facdefectocc")
        End If
    End If
    
    datencabezado.Recordset.Fields("fechadeentrega") = DateValue(frmnota_venta_cobrar_cobrar.Text3.Text) + TimeValue(Str(Time))
    If frmnota_venta_cobrar_cobrar.Text13.Text = "" Then frmnota_venta_cobrar_cobrar.Text13.Text = 0
    datencabezado.Recordset.Fields("recargo") = Round(frmnota_venta_cobrar_cobrar.Text13.Text, 2)
    datencabezado.Recordset.Fields("tiporecargo") = "$"
    If frmnota_venta_cobrar_cobrar.Text11.Text = "" Then frmnota_venta_cobrar_cobrar.Text11.Text = 0
    datencabezado.Recordset.Fields("bonificacion") = Round(frmnota_venta_cobrar_cobrar.Text11.Text, 2)
    datencabezado.Recordset.Fields("tipobonificacion") = "$"
    datencabezado.Recordset.Fields("importeglobal") = Round(frmnota_venta_cobrar_cobrar.Text4.Text, 2)
    datencabezado.Recordset.Fields("domicilioid") = frmnota_venta_cobrar_cobrar.Text1(3).Text
    If frmnota_venta_cobrar_cobrar.DataGrid2.Columns("domicilio_id").Text <> "" Then
        datencabezado.Recordset.Fields("domicilio_id") = frmnota_venta_cobrar_cobrar.DataGrid2.Columns("domicilio_id").Text
    End If
    datencabezado.Recordset.Fields("domiciliodeentregaid") = frmnota_venta_cobrar_cobrar.DataGrid2.Columns("domicilio_id").Text
    datencabezado.Recordset.Fields("subtotalsiniva") = Round(frmnota_venta_cobrar_cobrar.Text5.Text, 2)
    datencabezado.Recordset.Fields("totaliva") = Round(frmnota_venta_cobrar_cobrar.Text6.Text, 2) + Round(frmnota_venta_cobrar_cobrar.Text7.Text, 2)
    ...
    datencabezado.Recordset.Fields("target") = frmnota_venta_cobrar_cobrar.datparametros.Recordset.Fields("sucursal")
    ...
    datencabezado.Recordset.Fields("tipodefactura") = frmnota_venta_cobrar_cobrar.Text1(2).Text
    datencabezado.Recordset.Fields("percepiibb") = Round(frmnota_venta_cobrar_cobrar.Text9.Text, 2)
    datencabezado.Recordset.Fields("perceptem") = Round(frmnota_venta_cobrar_cobrar.Text8.Text, 2)
    datencabezado.Recordset.Fields("totaltr") = Round(frmnota_venta_cobrar_cobrar.Text4.Text, 2)
...
'--- Graba Items
    ...
    For X = 1 To xlineasmax
        If frmnota_venta_cobrar_cobrar.grilla.TextMatrix(1, 0) = "" Then
          mensa = MsgBox("No puede Grabar esta Venta sin Items", vbCritical, "Error")
          Exit Sub
        End If
        If frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 0) = "" Then Exit For
        
        datitems.Recordset.AddNew
        datitems.Recordset.Fields("claveprimaria") = xid
        datitems.Recordset.Fields("idproducto") = frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 0)
        datitems.Recordset.Fields("codigoproducto") = frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 1)
        datitems.Recordset.Fields("nombre_producto") = frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 2)
        datitems.Recordset.Fields("cantidadproducto") = frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 3)
        datitems.Recordset.Fields("unidaddemedidaid") = frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 4)
        datitems.Recordset.Fields("preciou") = Round(frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 6), 3)
        datitems.Recordset.Fields("preciousiva") = Round(frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 5), 3)
        datitems.Recordset.Fields("bonificacionitem") = frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 9)
        datitems.Recordset.Fields("importedebonificacion") = Round(frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 8), 4)
        datitems.Recordset.Fields("subtotal") = Round(frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 10), 4)
        datitems.Recordset.Fields("iva") = (Round(frmnota_venta_cobrar_cobrar.grilla.TextMatrix(X, 12), 4) - 1) * 100
...
'On Error GoTo errorgrabar
    ...
    If frmnota_venta_cobrar_cobrar.tipofac <> "NN" Then
        datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_cobrar_cobrar.datparametros.Recordset.Fields("remitodefecto")
    Else
        datencabezado.Recordset.Fields("tipodefacturacionid") = frmnota_venta_cobrar_cobrar.tipofac
    End If
    ...
    datencabezado.Recordset.Fields("responsabilidad") = frmnota_venta_cobrar.DataGrid2.Columns(16).Text
    datencabezado.Recordset.Fields("transferido") = "False"
...
'--- Graba Items
    ...
    For X = 1 To xlineasmax
        ...
        datitems.Recordset.Fields("referenciaproducto") = frmnota_venta_cobrar.grilla.TextMatrix(X, 1)
        datitems.Recordset.Fields("nombre_producto") = frmnota_venta_cobrar.grilla.TextMatrix(X, 2)
        datitems.Recordset.Fields("cantidadoriginal") = frmnota_venta_cobrar.grilla.TextMatrix(X, 3)
        datitems.Recordset.Fields("cantidadremitida") = frmnota_venta_cobrar.grilla.TextMatrix(X, 3)
        datitems.Recordset.Fields("cantidadaremitir") = frmnota_venta_cobrar.grilla.TextMatrix(X, 3)
        
        datitems.Recordset.Fields("unidaddemedida") = frmnota_venta_cobrar.grilla.TextMatrix(X, 4)
        
        datitems.Recordset.Fields("facturaorigen") = xid
        datitems.Recordset.UpdateBatch adAffectCurrent
        frmnota_venta_cobrar.grilla.TextMatrix(X, 15) = xid
        frmnota_venta_cobrar.grilla.TextMatrix(X, 16) = datitems.Recordset.Fields("id")
    Next X
...
'      End If
    ...
    .ReportSource = 0
    .SQLQuery = tabla
 Rem   .Destination = crptToWindowfrmnota_venta_cobrar.Text1(2).Text
