...
Public Const LOCALE_ICURRENCY = &H1B 'posición del simbolo de moneda respecto al número,0=delante, 1=detrás, 2=delante con un blanco, 3=detras con un blanco
...
Public Const LOCALE_INEGSEPBYSPACE = &H57 'un espacio entre el nº y la moneda en los negativos
...
'sólo se pueden modificar los siguientes valores :
'LOCALE_SDATE
'LOCALE_ICURRDIGITS
'LOCALE_SDECIMAL
'LOCALE_ICURRENCY
