...
Begin VB.Form lista_productos_servicios_colon 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Maestro de Articulos, Servicios y Conceptos"
   ClientHeight    =   7830
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14265
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "lista_productos_servicios_colon.frx":0000
      Height          =   6735
      Left            =   120
      TabIndex        =   1
      Top             =   600
   ...
   End
End
Attribute VB_Name = "lista_productos_servicios_colon"
    ...
    If KeyAscii = 13 Then
        KeyAscii = 0
            ...
            If menu = 3 Then
                ...
                frmfacctacte_alquiler.grilla.Text = DataGrid1.Columns("um").Text
        ...
        If Text1.Text <> "" Then
           ...
           vinicio = 1
            ...
            xquery1 = "SELECT     p.ID, p.CODIGO AS Codigo, p.DESCRIPCION AS Producto, t.CODIGO AS Marca, " & _
                      ...
                      "Where (p.ACTIVESTATUS <> 2) And (p.TIPOOBJETOESTATICO_ID Is Null) and " & _
                      ...
                      "Union All  " & _
                      "select ID, codigo, DESCRIPCION, 'Servicio','',0,'01/01/2000', '','', 'Servicio','Unidad', CODIGO + ' ' + DESCRIPCION as concatenado from V_SERVICIO_ " & _
                      "where ACTIVESTATUS <> 2 and CODIGO + ' ' + DESCRIPCION like '" & xbusqueda & "' " & _
                      "Union All " & _
                      "select ID, codigo, DESCRIPCION, 'Concepto','',0,'01/01/2000', '','', 'Concepto','Unidad', CODIGO + ' ' + DESCRIPCION as concatenado from V_CONCEPTOCONTABLE_ " & _
                      "where ACTIVESTATUS <> 2 and CODIGO + ' ' + DESCRIPCION like '" & xbusqueda & "' " & _
