...
Begin VB.Form frmclcompras 
   Caption         =   "Cierre de Libro / Ver Libro Compra"
   ClientHeight    =   6525
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11685
   Icon            =   "frmcierrrelibrocompras.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6525
   ScaleWidth      =   11685
   ...
   Begin VB.CommandButton salir 
      ...
      Height          =   855
      Left            =   8760
      Picture         =   "frmcierrrelibrocompras.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   9
      Top             =   240
      UseMaskColor    =   -1  'True
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmcierrrelibrocompras.frx":0884
      Height          =   4095
      Left            =   120
      TabIndex        =   7
      Top             =   1560
   ...
   Begin VB.CommandButton Aceptar 
      ...
      Height          =   855
      Left            =   10440
      Picture         =   "frmcierrrelibrocompras.frx":089F
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   240
      UseMaskColor    =   -1  'True
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "frmcierrrelibrocompras.frx":0CE1
      Height          =   1335
      Left            =   840
      TabIndex        =   8
      Top             =   2880
   ...
   Begin VB.CommandButton ver 
      ...
      Height          =   735
      Left            =   6600
      Picture         =   "frmcierrrelibrocompras.frx":0CFB
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   120
      UseMaskColor    =   -1  'True
   ...
   Begin vbskpro.Skinner Skinner1 
      ...
      LcK2            =   $"frmcierrrelibrocompras.frx":1005
      AmbientB        =   ";<=>?7B:><7=<A<7CC;@"
   ...
   End
End
Attribute VB_Name = "frmclcompras"
...
Public mescierre As String
Public meslista1 As String
...
Dim perhasta As String
    ...
    If login.livacomprascerrar = "N" Then
  ...
  perdesde = desde
  perhasta = hasta
  Respuesta = MsgBox("ESTA POR CERRAR EL LIBRO COMPRAS del mes: " + mescierre + " , correspondiente al periodo " + perdesde + "-" + perhasta + " , ESTA SEGURO?", vbYesNo, "Atención")
If Respuesta = vbYes Then
 datPrimaryRS.RecordSource = "select librocompras.* from librocompras WHERE fecha >= '" & frmclcompras.desde & "' and fecha <= '" & frmclcompras.hasta & "' and empresa = " & login.empresaact & " and inicioper = '" & login.iper & "' and librocompras.cerrado = 'N'"
...
Loop
    ...
    Inicio.datauditoria.Recordset.Fields("ventana") = "Cierre Libro Compras"
...
On Error GoTo fuera
      ...
      frmclcompras.desde = DTPicker1.Value
...
On Error GoTo fuera
    ...
    frmclcompras.hasta = DTPicker2.Value
    Call Ver_Click
...
datPrimaryRS.ConnectionString = login.conexiontotal
 ...
 datPrimaryRS.RecordSource = "select librocompras.* from librocompras WHERE librocompras.empresa = " & login.empresaact & " and inicioper = '" & login.iper & "' and finper = '" & login.fper & "' and cerrado = 'N' Order by fecha"
 datPrimaryRS.Refresh
 If datPrimaryRS.Recordset.EOF = False Then
    datPrimaryRS.Recordset.MoveFirst
    desde = datPrimaryRS.Recordset.Fields(2)
 Else
    desde = Date - Day(Date) + 1
 End If
  
 datcolumnas.RecordSource = "select columnascompra.* from columnascompra where empresa = " & login.empresaact & " and inicioper = '" & login.iper & "' and finper = '" & login.fper & "'"
 datcolumnas.Refresh
...
Dim suma(16) As Currency
    ...
    datPrimaryRS.RecordSource = "select librocompras.* from librocompras where (empresa = " & login.empresaact & " and fecha >= '" & frmclcompras.desde & "' and fecha <= '" & frmclcompras.hasta & "' and cerrado = 'N') and inicioper = '" & login.iper & "' and finper = '" & login.fper & "' Order by fecha"
    datPrimaryRS.Refresh
