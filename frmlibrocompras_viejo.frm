...
Begin VB.Form frmlibrocompras_viejo 
   ...
   ClientWidth     =   14610
   ControlBox      =   0   'False
   Icon            =   "frmlibrocompras_viejo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6765
   ...
   Begin VB.CommandButton borrar 
      ...
      Height          =   615
      Left            =   6480
      Picture         =   "frmlibrocompras_viejo.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   28
      Top             =   1560
      UseMaskColor    =   -1  'True
   ...
   Begin MSDataListLib.DataList DataList1 
      Bindings        =   "frmlibrocompras_viejo.frx":0544
      Height          =   1605
      Left            =   2640
      TabIndex        =   6
      Top             =   960
   ...
   Begin MSDataListLib.DataList DataList3 
      Bindings        =   "frmlibrocompras_viejo.frx":0561
      Height          =   1620
      Left            =   360
      TabIndex        =   98
      Top             =   3120
   ...
   Begin MSDataListLib.DataList DataList2 
      Bindings        =   "frmlibrocompras_viejo.frx":057E
      Height          =   1620
      Left            =   120
      TabIndex        =   97
      Top             =   4680
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "frmlibrocompras_viejo.frx":0597
      Height          =   1335
      Left            =   8040
      TabIndex        =   49
      Top             =   2280
   ...
   Begin VB.CommandButton salir 
      ...
      Height          =   615
      Left            =   6480
      Picture         =   "frmlibrocompras_viejo.frx":05B1
      Style           =   1  'Graphical
      TabIndex        =   29
      Top             =   2880
      UseMaskColor    =   -1  'True
   ...
   Begin VB.CommandButton Cancelar 
      ...
      Height          =   615
      Left            =   6480
      Picture         =   "frmlibrocompras_viejo.frx":09F3
      Style           =   1  'Graphical
      TabIndex        =   27
      Top             =   960
      UseMaskColor    =   -1  'True
   ...
   Begin VB.CommandButton nuevo 
      ...
      Height          =   615
      Left            =   6480
      Picture         =   "frmlibrocompras_viejo.frx":0F25
      Style           =   1  'Graphical
      TabIndex        =   26
      Top             =   360
      UseMaskColor    =   -1  'True
   ...
   Begin VB.ListBox List1 
      BackColor       =   &H00FFFFFF&
      Height          =   840
      ItemData        =   "frmlibrocompras_viejo.frx":1457
      Left            =   1200
      List            =   "frmlibrocompras_viejo.frx":1459
      Sorted          =   -1  'True
      TabIndex        =   7
      Top             =   1320
      Visible         =   0   'False
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmlibrocompras_viejo.frx":145B
      Height          =   6495
      Left            =   8040
      Negotiate       =   -1  'True
      TabIndex        =   4
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   615
         Left            =   480
         Picture         =   "frmlibrocompras_viejo.frx":1476
         Style           =   1  'Graphical
         TabIndex        =   116
         Top             =   2160
         UseMaskColor    =   -1  'True
   ...
   Begin MSDataGridLib.DataGrid DataGrid3 
      Bindings        =   "frmlibrocompras_viejo.frx":34E8
      Height          =   735
      Left            =   8160
      TabIndex        =   54
      Top             =   3840
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmlibrocompras_viejo.frx":3501
         Height          =   315
         Left            =   1680
         TabIndex        =   107
         Top             =   240
   ...
   Begin vbskpro.Skinner Skinner1 
      ...
      LcK2            =   $"frmlibrocompras_viejo.frx":351A
      AmbientB        =   ";<=>?7B:><7=<A<7CC;@"
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   975
      Left            =   6480
      Picture         =   "frmlibrocompras_viejo.frx":3529
      Style           =   1  'Graphical
      TabIndex        =   108
      Top             =   4920
      UseMaskColor    =   -1  'True
   ...
   End
End
Attribute VB_Name = "frmlibrocompras_viejo"
...
Rem            mensa = MsgBox("La Fecha pertenece a un mes anterior, no se modifica Asiento Contable", vbCritical, "!! Atención !!")
Rem        fechamal = 1
Rem        Exit Sub
Rem    End If
