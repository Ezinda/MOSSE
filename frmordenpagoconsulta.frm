...
Begin VB.Form frmreciboconsulta 
   ...
   ClientTop       =   330
   ClientWidth     =   4260
   Icon            =   "frmordenpagoconsulta.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton Command4 
      ...
      Height          =   735
      Left            =   480
      Picture         =   "frmordenpagoconsulta.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   1200
      UseMaskColor    =   -1  'True
   ...
   Begin MSDataListLib.DataCombo DataCombo1 
      Bindings        =   "frmordenpagoconsulta.frx":0544
      Height          =   360
      Left            =   240
      TabIndex        =   0
      Top             =   480
   ...
   Begin VB.CommandButton salir 
      ...
      Height          =   735
      Left            =   2280
      Picture         =   "frmordenpagoconsulta.frx":0561
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   1200
      UseMaskColor    =   -1  'True
   ...
   Begin vbskpro.Skinner Skinner1 
      ...
      LcK2            =   $"frmordenpagoconsulta.frx":09A3
      AmbientB        =   ";<=>?7B:><7=<A<7CC;@"
