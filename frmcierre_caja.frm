...
Begin VB.Form frmcierre_caja 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmcierre_caja.frx":0000
      Height          =   5175
      Left            =   120
      TabIndex        =   1
      Top             =   600
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin KewlButtonz.KewlButtons traervalores 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmcierre_caja.frx":001A
         PICN            =   "frmcierre_caja.frx":0036
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons transferir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmcierre_caja.frx":05D0
      PICN            =   "frmcierre_caja.frx":05EC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons transferir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmcierre_caja.frx":0B86
      PICN            =   "frmcierre_caja.frx":0BA2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons transferir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmcierre_caja.frx":113C
      PICN            =   "frmcierre_caja.frx":1158
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons transferir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmcierre_caja.frx":16F2
      PICN            =   "frmcierre_caja.frx":170E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons transferir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmcierre_caja.frx":1CA8
      PICN            =   "frmcierre_caja.frx":1CC4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons KewlButtons1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmcierre_caja.frx":225E
      PICN            =   "frmcierre_caja.frx":227A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons deshacer 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmcierre_caja.frx":2814
      PICN            =   "frmcierre_caja.frx":2830
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons deshacer 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmcierre_caja.frx":2DCA
      PICN            =   "frmcierre_caja.frx":2DE6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons deshacer 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmcierre_caja.frx":3380
      PICN            =   "frmcierre_caja.frx":339C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons deshacer 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmcierre_caja.frx":3936
      PICN            =   "frmcierre_caja.frx":3952
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons deshacer 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmcierre_caja.frx":3EEC
      PICN            =   "frmcierre_caja.frx":3F08
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmcierre_caja"
...
frmcierre_caja.Top = yventana - frmalquiler_devolucion.Height / 2
frmcierre_caja.Left = xventana - frmalquiler_devolucion.Width / 2
...
If datcierre.Recordset.EOF = False Then
  ...
  Do While Not datcierre.Recordset.EOF
            ...
            If datcierre2.Recordset.EOF = False Then
                ...
                'datcierre2.Recordset.Fields("usuario") = login.usuarioactivo
                xcaja = 1
