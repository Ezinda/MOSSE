...
Begin VB.Form frmajusteclientes 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ajustes de EC de Clientes"
   ClientHeight    =   7650
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8715
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataListLib.DataCombo DataCombo4 
         Bindings        =   "frmajusteclientes.frx":0000
         Height          =   315
         Left            =   1920
         TabIndex        =   30
         Top             =   240
      ...
      Begin MSDataListLib.DataCombo DataCombo6 
         Bindings        =   "frmajusteclientes.frx":001A
         Height          =   315
         Left            =   4920
         TabIndex        =   31
         Top             =   600
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabsPerRow      =   5
      TabHeight       =   1147
      TabCaption(0)   =   "Cambiar el Cliente de Una Factura o NC"
      TabPicture(0)   =   "frmajusteclientes.frx":0037
      ...
      TabCaption(1)   =   "Reasignar Cobros Mal asignados a Facturas"
      TabPicture(1)   =   "frmajusteclientes.frx":0053
      ...
      TabPicture(4)   =   "frmajusteclientes.frx":00A7
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "Frame7"
      Tab(4).Control(1)=   "Command4"
      Tab(4).Control(2)=   "datasiento"
      Tab(4).Control(3)=   "datmaestro"
      Tab(4).Control(4)=   "grabaasiento"
      Tab(4).ControlCount=   5
      Begin MSDataGridLib.DataGrid DataGrid3 
         Bindings        =   "frmajusteclientes.frx":00C3
         Height          =   975
         Left            =   240
         TabIndex        =   70
         Top             =   5760
      ...
      Begin VB.CommandButton Command4 
         ...
         Height          =   615
         Left            =   -71400
         Picture         =   "frmajusteclientes.frx":00DC
         Style           =   1  'Graphical
         TabIndex        =   40
         Top             =   5520
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   615
         Left            =   -71520
         Picture         =   "frmajusteclientes.frx":060E
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   6000
         UseMaskColor    =   -1  'True
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmajusteclientes.frx":0B40
         Height          =   255
         Left            =   -74760
         TabIndex        =   38
         Top             =   5640
      ...
      Begin VB.Frame Frame6 
         ...
         Begin MSDataListLib.DataCombo DataCombo7 
            Bindings        =   "frmajusteclientes.frx":0B5C
            Height          =   315
            Left            =   1080
            TabIndex        =   34
            Top             =   360
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmajusteclientes.frx":0B78
         Height          =   735
         Left            =   4920
         TabIndex        =   29
         Top             =   4800
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   615
         Left            =   3240
         Picture         =   "frmajusteclientes.frx":0B94
         Style           =   1  'Graphical
         TabIndex        =   28
         Top             =   5760
         UseMaskColor    =   -1  'True
      ...
      Begin VB.Frame Frame5 
         ...
         Begin MSDataListLib.DataCombo DataCombo5 
            Bindings        =   "frmajusteclientes.frx":10C6
            Height          =   315
            Left            =   1920
            TabIndex        =   26
            Top             =   360
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   615
         Left            =   -70440
         Picture         =   "frmajusteclientes.frx":10E2
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   5880
         UseMaskColor    =   -1  'True
      ...
      Begin VB.Frame Frame4 
         ...
         Begin MSDataListLib.DataCombo DataCombo2 
            Bindings        =   "frmajusteclientes.frx":1614
            Height          =   315
            Left            =   720
            TabIndex        =   17
            Top             =   360
         ...
         Begin MSDataListLib.DataCombo DataCombo3 
            Bindings        =   "frmajusteclientes.frx":162E
            Height          =   315
            Left            =   1320
            TabIndex        =   20
            Top             =   780
      ...
      Begin VB.CommandButton grabar 
         ...
         Height          =   615
         Left            =   -71760
         Picture         =   "frmajusteclientes.frx":1648
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   4800
         UseMaskColor    =   -1  'True
      ...
      Begin VB.Frame Frame2 
         ...
         Begin MSDataListLib.DataCombo DataCombo1 
            Bindings        =   "frmajusteclientes.frx":1B7A
            Height          =   315
            Left            =   720
            TabIndex        =   2
            Top             =   360
      ...
      Begin MSDataGridLib.DataGrid DataGrid4 
         Bindings        =   "frmajusteclientes.frx":1B94
         Height          =   975
         Left            =   5040
         TabIndex        =   71
         Top             =   5760
   ...
   Begin vbskpro.Skinner Skinner1 
      ...
      LcK2            =   $"frmajusteclientes.frx":1BAE
      AmbientB        =   ";<=>?7B:><7=<A<7CC;@"
   ...
   End
End
Attribute VB_Name = "frmajusteclientes"
...
If SSTab1.Tab = 0 Or SSTab1.Tab = 2 Or SSTab1.Tab = 3 Or SSTab1.Tab = 4 Then
        datlibroventas.RecordSource = "select libroventas.* from libroventas WHERE empresa = " & login.empresaact & "  and cliente = '" & DataCombo4.Text & "' and tipocompr = '" & Combo1.Text & "' and numcompr = '" & MaskEdBox1.Text & "'"
        ...
        Text1(1).Text = datlibroventas.Recordset.Fields("cliente")
        ...
        If SSTab1.Tab = 2 Then
             datclientes.RecordSource = "select clientes.* from clientes where empresa = " & login.empresaact & " and razonsocial = '" & datlibroventas.Recordset.Fields("cliente") & "' "
             datclientes.Refresh
            
             datrecibosinc.RecordSource = "select consultarecibosinc.* from consultarecibosinc where codcliente = " & datclientes.Recordset.Fields("codcliente") & ""
            ...
            datasiento1.RecordSource = "select [Detalle Asientos].* from [Detalle Asientos] where empresa = " & login.empresaact & " and idmasterasientos = " & idmast & " and debe <> 0  "
            datasiento1.Refresh
        ...
        If SSTab1.Tab = 3 Then
             ...
             datrecibosinc.RecordSource = "select conceptoscobran1.* from conceptoscobran1 where empresa = " & login.empresaact & " and cliente = '" & datclientes.Recordset.Fields("razonsocial") & "' and (tipocompr = 'NCA' or tipocompr = 'NCB' or tipocompr = 'NCC')  order by comp"
             datrecibosinc.Refresh
...
If SSTab1.Tab = 1 Then
    If Text2.Text <> " " Then
        datlibroventas.RecordSource = "select libroventas.* from libroventas WHERE empresa = " & login.empresaact & " and tipocompr = '" & Combo1.Text & "' and numcompr = '" & MaskEdBox1.Text & "' "
        datlibroventas.Refresh
    Else
        datlibroventas.RecordSource = "select libroventas.* from libroventas WHERE empresa = " & login.empresaact & " and tipocompr = '" & Text2.Text & "' and numcompr = '" & DataCombo6.Text & "' and cliente = '" & DataCombo4.Text & "' "
        datlibroventas.Refresh
    End If
        ...
        datrecibosabonan.RecordSource = "select recibocobroabonan.* from recibocobroabonan WHERE empresa = " & login.empresaact & " and comprobante = '" & compro & "' and nomcliente = '" & Text1(1).Text & "'  "
        ...
        Do While Not datrecibosabonan.Recordset.EOF
            datrecibos.RecordSource = "select recibocobro.* from recibocobro where empresa = " & login.empresaact & " and nrorden = '" & datrecibosabonan.Recordset.Fields("nrorden") & "' and anulado <> 'S'"
            datrecibos.Refresh
...
sincomp:
    ...
    If DataCombo2.Text = "" Then
        mensa = MsgBox("Ingrese el Cliente de Destino", vbCritical, "Error")
        DataCombo2.SetFocus
        Exit Sub
    End If
    datrecibosabonan.RecordSource = "select recibocobroabonan.* from recibocobroabonan WHERE empresa = " & login.empresaact & " and id = '" & numorden & "'  "
    datrecibosabonan.Refresh
    
    If datrecibosabonan.Recordset.EOF = True Then GoTo fuera
    
    datrecibosabonan.Recordset.Fields("nomcliente") = DataCombo2.Text
    datrecibosabonan.Recordset.Fields("codcliente") = DataCombo2.BoundText
    ...
    If DataCombo3.Text <> "" Then
        datlibroventas.RecordSource = "select libroventas.* from libroventas WHERE empresa = " & login.empresaact & " and cliente ='" & DataCombo2.Text & "' and tipocompr = '" & Left(DataCombo3.Text, 3) & "' and numcompr = '" & Right(DataCombo3.Text, 13) & "' "
        datlibroventas.Refresh
...
ajustes:
    ...
    datlibroventas1.RecordSource = "select libroventas.* from libroventas WHERE empresa = " & login.empresaact & " and cliente ='" & DataCombo2.Text & "' and numcompr = '" & DataCombo6.Text & "' "
...
If datlibroventas1.Recordset.EOF = True Then
    ...
    Next X
        ...
        datlibroventas1.Recordset.Fields("cliente") = DataCombo2.Text
...
auditoria:
                ...
                Inicio.datauditoria.Recordset.Fields("ventana") = "AJUSTES EC CLIENTES"
...
On Error GoTo fuera
    ...
    identi = DataGrid1.Columns(5).Text
    
        datrecibosabonan.RecordSource = "select recibocobroabonan.* from recibocobroabonan WHERE empresa = " & login.empresaact & " and id = " & identi & ""
        datrecibosabonan.Refresh
        datrecibosabonan1.RecordSource = "select recibocobroabonan.* from recibocobroabonan WHERE empresa = " & login.empresaact & ""
        ...
        cuentadebe = DataGrid3.Columns(2).Text
        cuentahaber = DataGrid4.Columns(2).Text
        ...
        If cuentadebe <> cuentahaber Then
                ...
                datmaestro.Recordset.Fields("concepto") = "Asignacion recibo:" + DataCombo5.Text
                ...
                datasiento.Recordset.Fields("detallefila") = "Recibo:" + DataCombo5.Text
...
On Error GoTo fuera
    ...
    End If
        ...
        datrecibosabonan.RecordSource = "select recibocobroabonan.* from recibocobroabonan WHERE empresa = " & login.empresaact & " "
        datrecibosabonan.Refresh
        ...
        datrecibosabonan.Recordset.Fields("inicioper") = datlibroventas.Recordset.Fields("inicioper")
        datrecibosabonan.Recordset.Fields("finper") = datlibroventas.Recordset.Fields("finper")
        datrecibosabonan.Recordset.Fields("codcliente") = datclientes.Recordset.Fields("codcliente")
        datrecibosabonan.Recordset.Fields("nomcliente") = datclientes.Recordset.Fields("razonsocial")
        datrecibosabonan.Recordset.Fields("codcliente") = datclientes.Recordset.Fields("codcliente")
        datrecibosabonan.Recordset.Fields("comprobante") = compro
        ...
        datlibroventas.RecordSource = "select libroventas.* from libroventas WHERE empresa = " & login.empresaact & " and tipocompr = '" & Left(DataCombo7.Text, 3) & "' and numcompr = '" & Right(DataCombo7.Text, 13) & "' and cliente = '" & datclientes.Recordset.Fields("razonsocial") & "' "
        datlibroventas.Refresh
...
On Error Resume Next
    ...
    datrecibosabonan.Recordset.Fields("codcliente") = DataCombo4.BoundText
    datrecibosabonan.Recordset.Fields("nomcliente") = DataCombo4.Text
    ...
    End If
    datrecibosabonan.Recordset.Fields("codcuenta") = datlibroventas.Recordset.Fields("cdt")
    datrecibosabonan.Recordset.Fields("saldofactura") = 0
    datrecibosabonan.Recordset.UpdateBatch adAffectCurrent
...
Private Sub DataCombo2_Click(Area As Integer)
    ...
    datasigcomp.RecordSource = "select conceptoscobran1.* from conceptoscobran1 where empresa = " & login.empresaact & " and cliente = '" & DataCombo2.Text & "'  order by comp"
    datasigcomp.Refresh
    DataCombo3.Text = ""
...
On Error Resume Next
    If KeyAscii = 13 Then
        KeyAscii = 0
        datasigcomp.RecordSource = "select conceptoscobran1.* from conceptoscobran1 where empresa = " & login.empresaact & " and cliente = '" & DataCombo2.Text & "' and comp = '" & DataCombo3.Text & "' order by comp "
        datasigcomp.Refresh
...
Private Sub DataCombo4_Click(Area As Integer)
        ...
        datlibroventas.RecordSource = "select libroventas.* from libroventas WHERE empresa = " & login.empresaact & " and cliente = '" & DataCombo4.Text & "'"
        datlibroventas.Refresh
...
On Error Resume Next
    ...
    If IsNull(DataCombo5.SelectedItem) = False Then
        ...
        datmaestro.RecordSource = "select [Maestro Asientos].* from [Maestro Asientos] where empresa = " & login.empresaact & " and perinicial = '" & DataGrid1.Columns(4).Text & "' and nroasiento = " & DataGrid1.Columns(11) & " "
        datmaestro.Refresh
        If datmaestro.Recordset.EOF = True Then
            idmast = 0
        Else
        ...
        datasiento.RecordSource = "select [Detalle Asientos].* from [Detalle Asientos] where empresa = " & login.empresaact & " and idmasterasientos = " & idmast & " and haber <> 0  "
        datasiento.Refresh
    End If
...
Private Sub Form_Activate()
    If login.ajusteclientes <> "S" Then
...
frmajusteclientes.Top = 0
frmajusteclientes.Left = 0
Aplicar_skin Me
    ...
    datasigcomp.RecordSource = "select conceptoscobran1.* from conceptoscobran1 where empresa = " & login.empresaact & " order by comp"
    datasigcomp.Refresh
...
On Error GoTo fuera
    ...
    If IsNull(datlibroventas.Recordset.Fields("cdt")) = True Then GoTo fuera
    ...
    datmaestro.Recordset.UpdateBatch adAffectCurrent
            ...
            datasiento.Recordset.Fields(2) = datlibroventas.Recordset.Fields("cdt")
...
On Error GoTo fuera
    ...
    datlibroventas.Recordset.Fields("cliente") = DataCombo1.Text
    ...
    datlibroventas.Recordset.UpdateBatch adAffectCurrent
                ...
                Inicio.datauditoria.Recordset.Fields("hora") = Str(Time)
                Inicio.datauditoria.Recordset.Fields("ventana") = "AJUSTES EC CLIENTES"
                Inicio.datauditoria.Recordset.Fields("accion") = "Cambio de Cliente en FACT:" + Combo1.Text + "-" + MaskEdBox1.Text
                Inicio.datauditoria.Recordset.Fields("usuario") = login.usuarioactivo
                Inicio.datauditoria.Recordset.Fields("empresa") = login.empresaact
                Inicio.datauditoria.Recordset.UpdateBatch adAffectCurrent
