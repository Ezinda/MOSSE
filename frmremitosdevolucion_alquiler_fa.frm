...
Begin VB.Form frmremitosdevolucion_alquiler_fa 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Remitos de Alquiler pendientes de Facturacion por anomalias"
   ClientHeight    =   7440
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   15195
   Icon            =   "frmremitosdevolucion_alquiler_fa.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   7440
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmremitosdevolucion_alquiler_fa.frx":0442
      Height          =   2775
      Left            =   120
      TabIndex        =   4
      Top             =   1080
   ...
   Begin VB.Frame Frame2 
      ...
      Begin KewlButtonz.KewlButtons Command4 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmremitosdevolucion_alquiler_fa.frx":045B
         PICN            =   "frmremitosdevolucion_alquiler_fa.frx":0477
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmremitosdevolucion_alquiler_fa.frx":3869
         PICN            =   "frmremitosdevolucion_alquiler_fa.frx":3885
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "frmremitosdevolucion_alquiler_fa.frx":43CF
      Height          =   2175
      Left            =   120
      TabIndex        =   10
      TabStop         =   0   'False
   ...
   Begin KewlButtonz.KewlButtons facturar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmremitosdevolucion_alquiler_fa.frx":43EB
      PICN            =   "frmremitosdevolucion_alquiler_fa.frx":4407
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin KewlButtonz.KewlButtons KewlButtons1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmremitosdevolucion_alquiler_fa.frx":49A1
      PICN            =   "frmremitosdevolucion_alquiler_fa.frx":49BD
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmremitosdevolucion_alquiler_fa"
...
Text2.Text = DataGrid1.Columns(16).Text
...
frmremitosdevolucion_alquiler_fa.Top = yventana - frmremitosdevolucion_alquiler_fa.Height / 2
frmremitosdevolucion_alquiler_fa.Left = xventana - frmremitosdevolucion_alquiler_fa.Width / 2
        ...
        If Text1.Text <> "" Then
            ...
            If Option4.Value = True Then
                ...
                xquery1 = "SELECT     id, Sel, NroRemito, Fecha, CodCliente, Cliente, CUIT, MAX(NroFactura) AS NroFactura , Tipopago, TipodeVenta, presupuestobase,Vendedor, MAX(cantremitida) " & _
                          "AS cantremitida, SUM(cantfacturada) AS cantfacturada, MAX(concatenado) AS concatenado, requierereparacion, NOTA, REPARACIONFACTURADA " & _
                          "FROM         (SELECT     TOP (50) R.id, R.Sel, R.NUMERODOCUMENTO AS NroRemito, R.FECHAEMISION AS Fecha, R.cod_cliente AS CodCliente, R.cliente AS Cliente, R.CUIT,  " & _
                          "R.vendedor AS Vendedor, R.tipopago AS Tipopago, R.TIPOVENTA AS TipodeVenta, R.presupuestobase,  " & _
                          "E.tipodefactura + ' ' + E.puntodeventa + RIGHT('0000000' + E.numerodefactura, 8) AS NroFactura, MAX(R.cantidadremitida) AS cantremitida,  " & _
                          ...
                          "+ 'f' AS concatenado, RD.numeradorinterno, RD.comprobanteorigen, RD.requierereparacion,RD.NOTA, RD.REPARACIONFACTURADA " & _
                          "FROM          ud_ezi_puntodeventa_encabezado AS RD WITH (readpast) INNER JOIN " & _
                          "v_ezi_pos_remito AS R ON RD.comprobanteorigen = R.id LEFT OUTER JOIN " & _
                          "ud_ezi_puntodeventa_detalle_factm AS IFAC WITH (readpast) LEFT OUTER JOIN " & _
                          "ud_ezi_puntodeventa_encabezado AS E WITH (readpast) ON IFAC.claveprimaria = E.id ON R.iditem = IFAC.iditemremito " & _
                          "GROUP BY R.id, R.Sel, R.NUMERODOCUMENTO, R.FECHAEMISION, R.cod_cliente, R.cliente, R.CUIT, R.vendedor, R.tipopago, R.TIPOVENTA, " & _
                          "E.tipodefactura + ' ' + E.puntodeventa + RIGHT('0000000' + E.numerodefactura, 8), R.presupuestobase, R.alquiler, RD.numeradorinterno, " & _
                          "RD.comprobanteorigen , RD.requierereparacion, RD.NOTA, RD.REPARACIONFACTURADA  " & _
                          "HAVING      (R.alquiler = 'S') AND  " & _
                          "(R.NUMERODOCUMENTO + 'r  ' + R.cliente + ' ' + R.CUIT + ' ' + ISNULL(E.tipodefactura + ' ' + E.puntodeventa + RIGHT('0000000' + E.numerodefactura, 8),  " & _
                          "'') + 'f' LIKE '" & xbusqueda & "') AND (RD.numeradorinterno = 'Remito de Devolucion')) AS RC " & _
                          "GROUP BY id, Sel, NroRemito, Fecha, CodCliente, Cliente, CUIT, Vendedor, Tipopago, TipodeVenta, presupuestobase, requierereparacion, NOTA, REPARACIONFACTURADA " & _
                          "HAVING      (requierereparacion = 'S') AND (reparacionfacturada IS NULL) ORDER BY id DESC"

            Else
                xquery1 = "SELECT     id, Sel, NroRemito, Fecha, CodCliente, Cliente, CUIT, MAX(NroFactura) AS NroFactura , Tipopago, TipodeVenta, presupuestobase,Vendedor, MAX(cantremitida) " & _
                          "AS cantremitida, SUM(cantfacturada) AS cantfacturada, MAX(concatenado) AS concatenado, requierereparacion, NOTA " & _
                          "FROM         (SELECT     TOP (50) R.id, R.Sel, R.NUMERODOCUMENTO AS NroRemito, R.FECHAEMISION AS Fecha, R.cod_cliente AS CodCliente, R.cliente AS Cliente, R.CUIT,  " & _
                          "R.vendedor AS Vendedor, R.tipopago AS Tipopago, R.TIPOVENTA AS TipodeVenta, R.presupuestobase,  " & _
                          "E.tipodefactura + ' ' + E.puntodeventa + RIGHT('0000000' + E.numerodefactura, 8) AS NroFactura, MAX(R.cantidadremitida) AS cantremitida,  " & _
                          "SUM(ISNULL(IFAC.cantidadproducto, 0)) AS cantfacturada,  " & _
                          "R.NUMERODOCUMENTO + 'r  ' + R.cliente + ' ' + R.CUIT + ' ' + ISNULL(E.tipodefactura + ' ' + E.puntodeventa + RIGHT('0000000' + E.numerodefactura, 8), '')  " & _
                          "+ 'f' AS concatenado, RD.numeradorinterno, RD.comprobanteorigen, RD.requierereparacion,RD.NOTA " & _
                          "FROM          ud_ezi_puntodeventa_encabezado AS RD WITH (readpast) INNER JOIN " & _
                          "v_ezi_pos_remito AS R ON RD.comprobanteorigen = R.id LEFT OUTER JOIN " & _
                          "ud_ezi_puntodeventa_detalle_factm AS IFAC WITH (readpast) LEFT OUTER JOIN " & _
                          "ud_ezi_puntodeventa_encabezado AS E WITH (readpast) ON IFAC.claveprimaria = E.id ON R.iditem = IFAC.iditemremito " & _
                          "GROUP BY R.id, R.Sel, R.NUMERODOCUMENTO, R.FECHAEMISION, R.cod_cliente, R.cliente, R.CUIT, R.vendedor, R.tipopago, R.TIPOVENTA, " & _
                          "E.tipodefactura + ' ' + E.puntodeventa + RIGHT('0000000' + E.numerodefactura, 8), R.presupuestobase, R.alquiler, RD.numeradorinterno, " & _
                          "RD.comprobanteorigen , RD.requierereparacion, RD.NOTA  " & _
                          "HAVING      (R.alquiler = 'S') AND  " & _
                          "(R.NUMERODOCUMENTO + 'r  ' + R.cliente + ' ' + R.CUIT + ' ' + ISNULL(E.tipodefactura + ' ' + E.puntodeventa + RIGHT('0000000' + E.numerodefactura, 8),  " & _
                          "'') + 'f' LIKE '" & xbusqueda & "') AND (RD.numeradorinterno = 'Remito de Devolucion')) AS RC " & _
                          "GROUP BY id, Sel, NroRemito, Fecha, CodCliente, Cliente, CUIT, Vendedor, Tipopago, TipodeVenta, presupuestobase, requierereparacion, NOTA " & _
                          "ORDER BY id DESC"
            End If
