...
Begin VB.Form frmtransferenciavalor 
   ...
   ClientTop       =   330
   ClientWidth     =   12045
   Icon            =   "frmtransferenciavalor.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmtransferenciavalor.frx":0442
         Height          =   1575
         Left            =   120
         TabIndex        =   20
         Top             =   2520
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmtransferenciavalor.frx":0459
         Height          =   420
         Left            =   2400
         TabIndex        =   2
         Top             =   1080
      ...
      Begin MSDataListLib.DataCombo DataCombo4 
         Bindings        =   "frmtransferenciavalor.frx":0472
         Height          =   420
         Left            =   2400
         TabIndex        =   13
         Top             =   600
      ...
      Begin MSDataListLib.DataCombo DataCombo2 
         Bindings        =   "frmtransferenciavalor.frx":0490
         Height          =   420
         Left            =   2400
         TabIndex        =   22
         Top             =   120
   ...
   Begin VB.Frame Frame3 
      ...
      Begin KewlButtonz.KewlButtons grabar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmtransferenciavalor.frx":04AE
         PICN            =   "frmtransferenciavalor.frx":04CA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmtransferenciavalor.frx":1F4C
         PICN            =   "frmtransferenciavalor.frx":1F68
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin MSAdodcLib.Adodc datimputaciones 
         ...
         _Version        =   393216
      End
      Begin MSAdodcLib.Adodc datcajaorigen 
         Height          =   330
         Left            =   4440
         Top             =   120
         Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmtransferenciavalor"
        ...
        Else
                ...
                Else
                    xquery = "SELECT     ud_ezi_pago.id, ud_ezi_pago.numero AS Numero, V_PERSONA_.NOMBRE AS Banco, ud_ezi_pago.fechadeemision AS Fec_Emi, " & _
                             "ud_ezi_pago.fechadevencimiento AS Fec_Venc, ud_ezi_pago.responsable AS Datos, monto as Importe " & _
                             "FROM         V_PERSONA_ RIGHT OUTER JOIN  " & _
                             "V_BANCO_ ON V_PERSONA_.ID = V_BANCO_.ENTEASOCIADO_ID RIGHT OUTER JOIN " & _
                             "ud_ezi_pago WITH (readpast) ON V_BANCO_.ID = ud_ezi_pago.bancoid " & _
...
If DataCombo2.BoundText <> datparametros.Recordset("cajadefecto") Then
    DataCombo4.BoundText = datparametros.Recordset("cajadefecto")
...
frmtransferenciavalor.Top = yventana - frmtransferenciavalor.Height / 2
frmtransferenciavalor.Left = xventana - frmtransferenciavalor.Width / 2
fecha = Date
...
datcajaorigen.ConnectionString = login.conexiontotal
datparametros.ConnectionString = login.conexiontotal
    ...
    datimputaciones.RecordSource = "SELECT     DESCRIPCION AS nombre, ID, ACTIVESTATUS From V_CAJA_ WHERE (ACTIVESTATUS = 0) AND (ID <> '4F87416C-569F-4C4E-9411-6F24E2CADD6A' AND ID <> '978D6FAC-7BC3-44EE-BEDD-B5641A087B11') ORDER BY nombre"
    datimputaciones.Refresh
    
    datcajaorigen.RecordSource = "SELECT     DESCRIPCION AS nombre, ID, ACTIVESTATUS From V_CAJA_ WHERE (ACTIVESTATUS = 0) AND (ID <> '4F87416C-569F-4C4E-9411-6F24E2CADD6A' AND ID <> '978D6FAC-7BC3-44EE-BEDD-B5641A087B11') ORDER BY nombre"
    datcajaorigen.Refresh
...
DataCombo2.BoundText = datparametros.Recordset("cajadefecto")
...
'On Error GoTo errorgrabar
 ...
 mensa = MsgBox("Desea Grabar este Transferencia de Valor ?", vbYesNo, "!! Atención !!")
 If mensa = vbYes Then
    ...
    datencabezado.Recordset.Fields("numeradorinterno") = "Transferencia de Valor"
    ...
    datencabezado.Recordset.Fields("clienteid") = DataCombo4.BoundText  ' Caja Destino
    'datencabezado.Recordset.Fields("vendedorid") = datparametros.Recordset("cajadefecto") ' Caja Origen
    datencabezado.Recordset.Fields("vendedorid") = DataCombo2.BoundText ' Caja Origen Modificado 28/12/2016
    ...
    xnumerador = "Transferencia de Valores"
...
'******* Graba Pago
    ...
    datpago.RecordSource = "select isnull(max(idtransferencia),0) as idtransferencia from ud_ezi_pago"
    datpago.Refresh
    xnrocierre = datpago.Recordset.Fields("idtransferencia") + 1
    ...
    For X = 1 To 29
      If grillac.TextMatrix(X, 0) = "" Then Exit For
       If grillac.TextMatrix(X, 1) = "Efectivo" Then
        ...
        If DataCombo2.BoundText <> datparametros.Recordset.Fields("cajadefecto") Then
            datpago.Recordset.Fields("destinoid") = DataCombo4.BoundText '  Caja Destino
       ...
       Else
        ...
        datpago.Recordset.Fields("usuario") = login.usuarioactivo
       End If
        ...
        datpago.Recordset.Fields("numeroorden") = "Transferencia"
        datpago.Recordset.Fields("sucursal") = login.nomsucursal
                        
        datpago.Recordset.Fields("fechacierrre") = DateValue(fecha.Value)
        datpago.Recordset.Fields("idtransferencia") = xnrocierre
...
'******* Graba ud_ezi_cola
        ...
        datcola.Recordset.Fields("tipodedocumentoid") = "Transferencia de Caja"
