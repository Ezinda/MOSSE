    ...
    If KeyAscii = 13 Then
        ...
        For X = 1 To 200
             If DataGrid1.Columns(0).Text = grillaf.TextMatrix(X, 0) Then
                MsgBox "Atencion, Comprobante ya seleccionado", vbInformation, "Atención"
                DataGrid1.SetFocus
                Exit Sub
             End If
...
'******* Graba ud_ezi_cola
        ...
        mensa = MsgBox("Imprime recibo ?", vbYesNo, "Impresión")
...
''''--------------
       ...
       If Index = 1 Then
        If Val(Text1(1).Text) = 0 Then
            MsgBox "Debe ingresar un importe Válido", vbCritical, "Error"
            Text1(1).Text = 0
    ...
    If KeyAscii = 13 Then
        ...
        For i = 1 To Len(Text9.Text)
            ...
            If Asc(car) < 48 Or Asc(car) > 58 Then
              MsgBox "Debe Ingresar un Numero de Cheque Válido", vbCritical, "Error"
              Text9.Text = ""
              Text9.SetFocus
              Exit Sub
            End If
