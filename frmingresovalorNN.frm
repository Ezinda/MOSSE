...
Begin VB.Form frmingreovalorNN 
   ...
   ClientTop       =   330
   ClientWidth     =   14280
   Icon            =   "frmingresovalorNN.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame cheques 
      ...
      Begin MSDataListLib.DataCombo DataCombo5 
         Bindings        =   "frmingresovalorNN.frx":0442
         Height          =   420
         Left            =   240
         TabIndex        =   30
         Top             =   1680
   ...
   Begin VB.Frame tarjeta 
      ...
      Begin MSDataListLib.DataCombo DataCombo2 
         Bindings        =   "frmingresovalorNN.frx":0459
         Height          =   420
         Left            =   240
         TabIndex        =   13
         Top             =   720
      ...
      Begin MSDataListLib.DataCombo DataCombo3 
         Bindings        =   "frmingresovalorNN.frx":0473
         Height          =   420
         Left            =   240
         TabIndex        =   16
         Top             =   1560
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "frmingresovalorNN.frx":048A
         Height          =   420
         Left            =   2400
         TabIndex        =   2
         Top             =   600
      ...
      Begin MSDataListLib.DataCombo DataCombo4 
         Bindings        =   "frmingresovalorNN.frx":04A3
         Height          =   420
         Left            =   2400
         TabIndex        =   41
         Top             =   120
   ...
   Begin VB.Frame Frame3 
      ...
      Begin KewlButtonz.KewlButtons grabar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmingresovalorNN.frx":04C1
         PICN            =   "frmingresovalorNN.frx":04DD
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons cancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmingresovalorNN.frx":1F5F
         PICN            =   "frmingresovalorNN.frx":1F7B
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmingreovalorNN"
...
'frmingreovalorNN.Top = yventana - frmingreovalorNN.Height / 2
'frmingreovalorNN.Left = xventana - frmingreovalorNN.Width / 2
frmingreovalorNN.Top = 0
frmingreovalorNN.Left = 0
frmingreovalorNN.Width = 8790
fecha = Date
