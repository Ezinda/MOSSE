...
reporte.SQL = "SELECT auditoria.fecha, auditoria.hora, auditoria.ventana, auditoria.accion, auditoria.usuario FROM contablesql.dbo.auditoria auditoria WHERE auditoria.empresa = " & login.empresaact & " and auditoria.fecha >= '" & cargadesde & "' and auditoria.fecha <= '" & cargahasta & "' "
tabla = reporte.SQL

With CrystalReporte
    .ReportFileName = App.Path & ruta + "\audita.rpt"
...
Private Sub listar_Click()
    ...
    Inicio.datauditoria.Recordset.Fields("ventana") = "Auditar Sistema"
    Inicio.datauditoria.Recordset.Fields("accion") = "Genera Reporte desde:" + Str(cargadesde) + " hasta:" + Str(cargahasta)
