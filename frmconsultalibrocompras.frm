...
Begin VB.Form frmconsutalibrocompras 
   ...
   ClientWidth     =   14610
   ControlBox      =   0   'False
   Icon            =   "frmconsultalibrocompras.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7575
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   855
      Left            =   6360
      Picture         =   "frmconsultalibrocompras.frx":0442
      Style           =   1  'Graphical
      TabIndex        =   106
      Top             =   5880
      UseMaskColor    =   -1  'True
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "frmconsultalibrocompras.frx":0884
      Height          =   1335
      Left            =   8040
      TabIndex        =   44
      Top             =   2280
   ...
   Begin VB.CommandButton salir 
      ...
      Height          =   735
      Left            =   6360
      Picture         =   "frmconsultalibrocompras.frx":089E
      Style           =   1  'Graphical
      TabIndex        =   25
      Top             =   3480
      UseMaskColor    =   -1  'True
   ...
   Begin VB.CommandButton borrar 
      ...
      Height          =   735
      Left            =   6360
      Picture         =   "frmconsultalibrocompras.frx":0CE0
      Style           =   1  'Graphical
      TabIndex        =   24
      Top             =   2040
      UseMaskColor    =   -1  'True
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmconsultalibrocompras.frx":1122
      Height          =   6015
      Left            =   8040
      Negotiate       =   -1  'True
      TabIndex        =   4
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   735
         Left            =   360
         Picture         =   "frmconsultalibrocompras.frx":113D
         Style           =   1  'Graphical
         TabIndex        =   107
         Top             =   2760
         UseMaskColor    =   -1  'True
   ...
   Begin MSDataGridLib.DataGrid DataGrid3 
      Bindings        =   "frmconsultalibrocompras.frx":289F
      Height          =   735
      Left            =   8160
      TabIndex        =   49
      Top             =   3840
   ...
   Begin vbskpro.Skinner Skinner1 
      ...
      LcK2            =   $"frmconsultalibrocompras.frx":28B8
      AmbientB        =   ";<=>?7B:><7=<A<7CC;@"
   ...
   End
End
Attribute VB_Name = "frmconsutalibrocompras"
...
Private Sub borrar_Click()
  ...
  datprimaryrs.RecordSource = "select librocompras.* from librocompras WHERE librocompras.empresa = " & login.empresaact & " and inicioper = '" & login.iper & "' and finper = '" & login.fper & "' and fecha >= '" & desde.Value & "' and fecha <= '" & hasta.Value & "' Order by fecha"
...
Private Sub buscar_Click()
        ...
        datprimaryrs.RecordSource = "select librocompras.* from librocompras WHERE librocompras.empresa = " & login.empresaact & " and tipocompr = '" & Combo1.Text & "' and numcompr = '" & MaskEdBox1.Text & "' "
        datprimaryrs.Refresh
...
Private Sub Command1_Click()
  ...
  datprimaryrs.RecordSource = "select librocompras.* from librocompras WHERE librocompras.empresa = " & login.empresaact & " and inicioper = '" & login.iper & "' and finper = '" & login.fper & "' Order by fecha"
  datprimaryrs.Refresh
...
Else
    reporte.SQL = "SELECT librocompras1.id, librocompras1.cerrado, librocompras1.empresa, librocompras1.inicioper, librocompras1.fecha, librocompras1.proveedor, librocompras1.tipoiva, librocompras1.cuit, librocompras1.tipocompr, librocompras1.numcompr, librocompras1.col1, librocompras1.col2, librocompras1.col3, librocompras1.col4, librocompras1.col5, librocompras1.col6, librocompras1.total, librocompras1.nomcol1, librocompras1.nomcol2, librocompras1.nomcol3, librocompras1.nomcol4, librocompras1.nomcol5, librocompras1.nomcol6, librocompras1.nomcol7, librocompras1.razonsocial FROM contablesql.dbo.librocompras1 librocompras1 WHERE librocompras1.empresa = " & login.empresaact & " and librocompras1.inicioper = '" & login.iper & "' and fecha >= '" & desde.Value & "' and fecha <= '" & hasta.Value & "' and contado = 'S' ORDER BY librocompras1.fecha ASC, librocompras1.id ASC"
End If
...
End With
    ...
    Inicio.datauditoria.Recordset.Fields("ventana") = "Consulta Facturas de Compras"
...
Private Sub DataGrid1_DblClick()
  ...
  If datprimaryrs.Recordset.Fields("cerrado") = "N" Then
      frmlibrocompras.datprimaryrs.RecordSource = "select librocompras.* from librocompras WHERE librocompras.empresa = " & login.empresaact & " and id = " & datprimaryrs.Recordset.Fields("id") & ""
      frmlibrocompras.datprimaryrs.Refresh
...
hasta.Value = login.fper
  ...
  frmconsutalibrocompras.Left = 0
  frmconsutalibrocompras.Top = 0
  ...
  datproveedores.RecordSource = "select codproveedor,empresa,razonsocial,tipoiva,cuit,domicilio,localidad,codpostal,telefono,email,contacto from proveedores Where empresa = " & login.empresaact & " ORDER BY razonsocial"
...
Private Sub Option1_Click(Index As Integer)
    ...
    If Option1(1).Value = True Then
        datprimaryrs.RecordSource = "select librocompras.* from librocompras WHERE librocompras.empresa = " & login.empresaact & " and inicioper = '" & login.iper & "' and finper = '" & login.fper & "' and fecha >= '" & desde.Value & "' and fecha <= '" & hasta.Value & "' Order by proveedor"
        datprimaryrs.Refresh
    End If
    If Option1(2).Value = True Then
        datprimaryrs.RecordSource = "select librocompras.* from librocompras WHERE librocompras.empresa = " & login.empresaact & " and inicioper = '" & login.iper & "' and finper = '" & login.fper & "' and fecha >= '" & desde.Value & "' and fecha <= '" & hasta.Value & "' Order by tipocompr"
        datprimaryrs.Refresh
    End If
    If Option1(3).Value = True Then
        datprimaryrs.RecordSource = "select librocompras.* from librocompras WHERE librocompras.empresa = " & login.empresaact & " and inicioper = '" & login.iper & "' and finper = '" & login.fper & "' and fecha >= '" & desde.Value & "' and fecha <= '" & hasta.Value & "' Order by numcompr"
        datprimaryrs.Refresh
    End If
