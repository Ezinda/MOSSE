...
Private Sub Form_Load()
    ...
    datmaestro.Refresh
    datmaestro1.RecordSource = "select [Maestro Asientos].* from [Maestro Asientos] where empresa = " & login.empresaact & " and perinicial = '" & login.iper & "' and perfinal = '" & login.fper & "' order by nroasiento"
    datmaestro1.Refresh
...
Private Sub Text1_KeyPress(Index As Integer, KeyAscii As Integer)
    ...
    If KeyAscii = 13 Or KeyAscii = 9 Then
        ...
        Call grabar_Click
            ...
            Text3(4).Text = frmcartera.DataGrid1.Columns(11).Value
            Text3(5).Text = 0
            Text3(6).Text = "Cheque"
