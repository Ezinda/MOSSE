...
Begin VB.Form lista_debitos_todas 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Consulta de Notas de Debitos"
   ClientHeight    =   8760
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13890
   ...
   Begin VB.Frame Frame1 
      ...
      Begin KewlButtonz.KewlButtons salir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "lista_debitos_todas.frx":0000
         PICN            =   "lista_debitos_todas.frx":001C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin KewlButtonz.KewlButtons Command4 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "lista_debitos_todas.frx":0B66
         PICN            =   "lista_debitos_todas.frx":0B82
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "lista_debitos_todas.frx":3F74
      Height          =   6855
      Left            =   120
      TabIndex        =   0
      Top             =   1560
   ...
   Begin MSDataGridLib.DataGrid DataGrid2 
      Bindings        =   "lista_debitos_todas.frx":3F91
      Height          =   1215
      Left            =   120
      TabIndex        =   1
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "lista_debitos_todas"
...
With CrystalReporte
    ...
    End If
    .WindowTitle = "Nota de Debito Vta Orig"
...
If Text1.Text = "" Then
    xquery1 = "SELECT  ud_ezi_puntodeventa_encabezado.claveprimaria AS Numero, ud_ezi_puntodeventa_encabezado.numerodefactura AS Nro, " & _
                      ...
                      "AS SALDO, isnull(V_TRCREDITOVENTA_.VALORTOTAL,0) AS NCIMPORTE, ud_ezi_puntodeventa_encabezado.nroorden as CAE " & _
                      ...
                      "WHERE     (ud_ezi_puntodeventa_encabezado.numeradorinterno LIKE '%NOTA DE DÉDITO DE VENTA%') and ud_ezi_puntodeventa_encabezado.sucursal = '" & xsuc & "' AND (ud_ezi_puntodeventa_encabezado.tipodefacturacionid <> 'NN') AND (V_TRFACTURAVENTA_.FLAG_ID IS NULL) AND (V_COMPROMISOPAGO_.NIVEL = 1 OR " & _
...
Else
            xquery1 = "SELECT     ud_ezi_puntodeventa_encabezado.claveprimaria AS Numero, ud_ezi_puntodeventa_encabezado.numerodefactura AS Nro, " & _
                      ...
                      "V_PERSONA_ RIGHT OUTER JOIN " & _
                      "V_CLIENTE_ ON V_PERSONA_.ID = V_CLIENTE_.ENTEASOCIADO_ID ON ud_ezi_puntodeventa_encabezado.clienteid = V_CLIENTE_.ID " & _
                      "WHERE     (ud_ezi_puntodeventa_encabezado.numeradorinterno LIKE '%NOTA DE DÉDITO DE VENTA%') AND (ud_ezi_puntodeventa_encabezado.tipodefacturacionid <> 'NN') AND ud_ezi_puntodeventa_encabezado.sucursal = '" & xsuc & "' and " & _
                      "(ud_ezi_puntodeventa_encabezado.numerodefactura + 'n ' + ud_ezi_puntodeventa_encabezado.cliente + ' ' + V_PERSONA_.CUIT + ' ' + ud_ezi_puntodeventa_encabezado.vendedor " & _
...
If Text1.Text = "" Then
 reporte.SQL = "SELECT     Numero, tipodefactura, fechadelcomprobante, numeradorinterno, codcliente, cliente, totaltr, NroRemito " & _
              "FROM         MMOSSE.dbo.v_ezi_pos_listadodebitos AS v_ezi_pos_listadodebitos " & _
              "WHERE     convert(date,v_ezi_pos_listadodebitos.fechadelcomprobante) >= '" & DesdeFecha.Value & "' and " & _
              "convert(date,v_ezi_pos_listadodebitos.fechadelcomprobante) <= '" & HastaFecha.Value & "' and " & _
              "v_ezi_pos_listadodebitos.sucursal = '" & login.nomsucursal & "' " & _
...
Else
 reporte.SQL = "SELECT     Numero, tipodefactura, fechadelcomprobante, numeradorinterno, codcliente, cliente, totaltr, NroRemito " & _
              ...
              "WHERE     convert(date,v_ezi_pos_listadodebitos.fechadelcomprobante) >= '" & DesdeFecha.Value & "' and " & _
              "convert(date,v_ezi_pos_listadodebitos.fechadelcomprobante) <= '" & HastaFecha.Value & "' and " & _
              "v_ezi_pos_listadodebitos.sucursal = '" & login.nomsucursal & "' and " & _
              "v_ezi_pos_listadodebitos.cliente = '" & DataGrid1.Columns("cliente").Text & "' " & _
              "order by fechadelcomprobante desc"
End If
...
With CrystalReporte
    .PrinterCollation = crptCollated
    .ReportFileName = App.Path & "\Reporte_listado_debitos.rpt"
...
datcomp.RecordSource = "SELECT  ud_ezi_puntodeventa_encabezado.claveprimaria AS Numero, ud_ezi_puntodeventa_encabezado.numerodefactura AS Nro, " & _
                       ...
                       "V_PERSONA_ RIGHT OUTER JOIN " & _
                       "V_CLIENTE_ ON V_PERSONA_.ID = V_CLIENTE_.ENTEASOCIADO_ID ON ud_ezi_puntodeventa_encabezado.clienteid = V_CLIENTE_.ID " & _
                       "WHERE     (ud_ezi_puntodeventa_encabezado.numeradorinterno LIKE '%NOTA DE DÉDITO DE VENTA%') AND (ud_ezi_puntodeventa_encabezado.tipodefacturacionid <> 'NN') AND " & _
...
'    If Round(datcomp.Recordset.Fields("importeiva105"), 2) = 0 And Round(datcomp.Recordset.Fields("importeiva21"), 2) = 0 Then
'      fe.f1IndiceItem = xi
'      fe.F1DetalleIvaId = 3
...
Option1.Value = True
lista_debitos_todas.Top = yventana - lista_debitos_todas.Height / 2
lista_debitos_todas.Left = xventana - lista_debitos_todas.Width / 2
